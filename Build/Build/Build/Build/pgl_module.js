...
async function Sh(t, e) {
  ...
  for (let s = 0; s < t.length; s++) {
    const a = new qi(t[s].data);
    n.set(t[s], a);
  }
  const i = /* @__PURE__ */ new Map();
  for (let s = 0; s < e.length; s++) {
    const a = new Ai(e[s][0], e[s][1], e[s].data);
    i.set(s, a);
  }
  return await Ln.create(n, i);
}
...
let va = class {
  ...
  constructor(e) {
    this.points = [], e.forEach((n) => {
      const i = new Rt(n.x, n.y, n.z);
      this.points.push(i);
    });
  }
};
function cc(t, e, n) {
  const i = new Rt(t.x, t.y, t.z), r = new Rt(e.x, e.y, e.z), s = [];
  for (let o = 0; o <= n; o++) {
    const c = o / n, l = c * i.x + (1 - c) * r.x, h = c * i.y + (1 - c) * r.y, f = c * i.z + (1 - c) * r.z, d = new Rt(l, h, f);
    s.push(d);
  }
  return new va(s);
}
...
function Ph(t) {
  ...
  return t.forEach((s) => {
    e += s.x, n += s.y, i += s.z;
  }), e = e / t.length, n = n / t.length, i = i / t.length, new Rt(e, n, i);
}
const $i = {
...
async function Dh(t, e, n = 100, i = 1, r = 1) {
  ...
  for (let S = 0; S < e; S++) {
    let x, R, b, w, P, y, v, C, z, U, N, X, G, K;
    for (const k of s.keys()) {
      const te = s.get(k);
      x = a.get(k), R = o.get(k), b = [], w = [], te.forEach((he) => {
        const ie = a.get(he), Se = o.get(he);
        b.push(ie), w.push(Se);
      }), N = At.calculateAverage(b), X = At.calculateAverage(w), P = [], y = [];
      let le, ve, Le, Xe;
      for (const he of t.nodes.keys())
        he != k && (Le = a.get(he), Xe = o.get(he), le = Le - x, ve = Xe - R, y.push(le), P.push(ve));
      z = r * 1 / (At.calculateAverage(y) * At.calculateAverage(y)), U = r * 1 / (At.calculateAverage(P) * At.calculateAverage(P)), v = i * (N - x), C = i * (X - R), G = i * (0 - x), K = i * (0 - R);
      const q = z + G + v + x, Q = U + K + C + R;
      a.set(k, q), o.set(k, Q);
    }
  }
  let h = /* @__PURE__ */ new Map();
  for (const S of a.keys())
    h.set(S, new Rt(a.get(S), 0, o.get(S)));
  const f = [], d = [], u = [];
  let _;
  for (const S of h.keys())
    _ = h.get(S), f.push(_.x), d.push(_.y), u.push(_.z);
  const g = At.calculateAverage(f), p = At.calculateAverage(d), m = At.calculateAverage(u), T = new Rt(
    -g,
    -p,
    -m
  );
...
function Lh(t) {
  ...
  for (const s of n.keys())
    r.set(s, new Rt(n.get(s), 0, i.get(s)));
  return r;
}
function lc(t, e) {
  const n = /* @__PURE__ */ new Map();
  ...
  for (let T = 0; T < e; T++)
    for (let S of i.keys()) {
      ...
      for (let x = 1; x < r.points.length - 1; x++) {
        ...
        g = l.x + 0.8 * (At.calculateAverage(a) || 0), p = l.y + 0.8 * (At.calculateAverage(o) || 0), m = l.z + 0.8 * (At.calculateAverage(c) || 0);
        const R = new Rt(g, p, m);
        r.points[x] = R;
      }
    }
  return i;
...
async function Fh(t, e, n, i) {
  ...
  for (const _ of r.keys()) {
    const g = s.get(_) * n, p = o.get(s.get(_)), m = 2 * Math.PI * (p.indexOf(_) / p.length), T = Math.sin(m) * g, S = Math.cos(m) * g, x = new Rt(T + l, -g + h, S + f);
    c.set(_, x);
  }
...
async function kh(t) {
  ...
  const r = /* @__PURE__ */ new Map(), s = new Rt(0, 0, 0);
  for (const c of i)
    r.set(c, new qi({ pos: s }));
...
async function Wh() {
  ...
  t.nodes.forEach((s) => {
    const a = s.id, o = new Rt(s.px * 50, 0, s.py * 50), c = s.member, l = new qi({ pos: o, size: 10, info: "Node Info", modularity: c });
    e.set(a, l);
  });
  for (let s = 0; s < t.edges.length; s++) {
    const a = t.edges[s], o = a[0], c = a[1], l = new Ai(o, c, {});
    n.set(s, l);
  }
  const i = await Ln.create(e, n), r = Vh.DrawEdgeLines(i, 20);
  return i.apply_edge_pos_maps(r), i;
}
const my = { LoadZKC: Gh, LoadZKCSimulated: Wh, LoadGraphFromEdgeListText: kh };
/**
 * @license
 * Copyright 2010-2024 Three.js Authors
 * SPDX-License-Identifier: MIT
 */
const xa = "170", _i = { ROTATE: 0, DOLLY: 1, PAN: 2 }, ui = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 }, Xh = 0, ja = 1, qh = 2, dc = 1, $h = 2, hn = 3, Pn = 0, Ct = 1, Kt = 2, Rn = 0, gi = 1, Za = 2, Ka = 3, Ja = 4, Yh = 5, Vn = 100, jh = 101, Zh = 102, Kh = 103, Jh = 104, Qh = 200, ef = 201, tf = 202, nf = 203, ws = 204, Rs = 205, rf = 206, sf = 207, af = 208, of = 209, cf = 210, lf = 211, hf = 212, ff = 213, df = 214, Cs = 0, Ps = 1, Ds = 2, Mi = 3, Ls = 4, Is = 5, Us = 6, Ns = 7, uc = 0, uf = 1, pf = 2, Cn = 0, mf = 1, _f = 2, gf = 3, vf = 4, xf = 5, Mf = 6, yf = 7, pc = 300, yi = 301, Si = 302, Fs = 303, Os = 304, Br = 306, zs = 1e3, Gn = 1001, Bs = 1002, It = 1003, Sf = 1004, Ji = 1005, Jt = 1006, Yr = 1007, Wn = 1008, un = 1009, mc = 1010, _c = 1011, Wi = 1012, Ma = 1013, Xn = 1014, Qt = 1015, Yi = 1016, ya = 1017, Sa = 1018, Ei = 1020, gc = 35902, vc = 1021, xc = 1022, qt = 1023, Mc = 1024, yc = 1025, vi = 1026, Ti = 1027, Ea = 1028, Ta = 1029, Sc = 1030, ba = 1031, Aa = 1033, br = 33776, Ar = 33777, wr = 33778, Rr = 33779, Hs = 35840, Vs = 35841, ks = 35842, Gs = 35843, Ws = 36196, Xs = 37492, qs = 37496, $s = 37808, Ys = 37809, js = 37810, Zs = 37811, Ks = 37812, Js = 37813, Qs = 37814, ea = 37815, ta = 37816, na = 37817, ia = 37818, ra = 37819, sa = 37820, aa = 37821, Cr = 36492, oa = 36494, ca = 36495, Ec = 36283, la = 36284, ha = 36285, fa = 36286, Ef = 3200, Tf = 3201, bf = 0, Af = 1, wn = "", Ot = "srgb", wi = "srgb-linear", Hr = "linear", je = "srgb", Jn = 7680, Qa = 519, wf = 512, Rf = 513, Cf = 514, Tc = 515, Pf = 516, Df = 517, Lf = 518, If = 519, eo = 35044, to = "300 es", fn = 2e3, Ur = 2001;
class $n {
...
class Hf {
  static getDataURL(e) {
    ...
    if (e instanceof HTMLCanvasElement)
      ...
      Qn === void 0 && (Qn = Xi("canvas")), Qn.width = e.width, Qn.height = e.height;
...
class Ac {
  constructor(e = null) {
    this.isSource = !0, Object.defineProperty(this, "id", { value: Vf++ }), this.uuid = ji(), this.data = e, this.dataReady = !0, this.version = 0;
  }
  set needsUpdate(e) {
    e === !0 && this.version++;
  }
...
function Kr(t) {
  return typeof HTMLImageElement < "u" && t instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && t instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && t instanceof ImageBitmap ? Hf.getDataURL(t) : t.data ? {
...
let kf = 0;
class xt extends $n {
  constructor(e = xt.DEFAULT_IMAGE, n = xt.DEFAULT_MAPPING, i = Gn, r = Gn, s = Jt, a = Wn, o = qt, c = un, l = xt.DEFAULT_ANISOTROPY, h = wn) {
    super(), this.isTexture = !0, Object.defineProperty(this, "id", { value: kf++ }), this.uuid = ji(), this.name = "", this.source = new Ac(e), this.mipmaps = [], this.mapping = n, this.channel = 0, this.wrapS = i, this.wrapT = r, this.magFilter = s, this.minFilter = a, this.anisotropy = l, this.format = o, this.internalFormat = null, this.type = c, this.offset = new we(0, 0), this.repeat = new we(1, 1), this.center = new we(0, 0), this.rotation = 0, this.matrixAutoUpdate = !0, this.matrix = new De(), this.generateMipmaps = !0, this.premultiplyAlpha = !1, this.flipY = !0, this.unpackAlignment = 4, this.colorSpace = h, this.userData = {}, this.version = 0, this.onUpdate = null, this.isRenderTargetTexture = !1, this.pmremVersion = 0;
  }
  get image() {
...
class st {
  ...
  setAxisAngleFromRotationMatrix(e) {
    ...
    if (Math.abs(h - d) < 0.01 && Math.abs(f - g) < 0.01 && Math.abs(_ - p) < 0.01) {
      ...
      n = Math.PI;
      const S = (l + 1) / 2, x = (u + 1) / 2, R = (m + 1) / 2, b = (h + d) / 4, w = (f + g) / 4, P = (_ + p) / 4;
      return S > x && S > R ? S < 0.01 ? (i = 0, r = 0.707106781, s = 0.707106781) : (i = Math.sqrt(S), r = b / i, s = w / i) : x > R ? x < 0.01 ? (i = 0.707106781, r = 0, s = 0.707106781) : (r = Math.sqrt(x), i = b / r, s = P / r) : R < 0.01 ? (i = 0.707106781, r = 0.707106781, s = 0) : (s = Math.sqrt(R), i = w / s, r = P / s), this.set(i, r, s, n), this;
    }
...
class Yn {
  ...
  intersectsTriangle(e) {
    if (this.isEmpty())
      return !1;
    this.getCenter(Ui), er.subVectors(this.max, Ui), ei.subVectors(e.a, Ui), ti.subVectors(e.b, Ui), ni.subVectors(e.c, Ui), gn.subVectors(ti, ei), vn.subVectors(ni, ti), Un.subVectors(ei, ni);
    let n = [
      0,
      -gn.z,
      gn.y,
    ...
    return !Qr(n, ei, ti, ni, er) || (n = [1, 0, 0, 0, 1, 0, 0, 0, 1], !Qr(n, ei, ti, ni, er)) ? !1 : (tr.crossVectors(gn, vn), n = [tr.x, tr.y, tr.z], Qr(n, ei, ti, ni, er));
  }
  clampPoint(e, n) {
...
const rn = [
  ...
  /* @__PURE__ */ new O(),
  /* @__PURE__ */ new O()
], kt = /* @__PURE__ */ new O(), Qi = /* @__PURE__ */ new Yn(), ei = /* @__PURE__ */ new O(), ti = /* @__PURE__ */ new O(), ni = /* @__PURE__ */ new O(), gn = /* @__PURE__ */ new O(), vn = /* @__PURE__ */ new O(), Un = /* @__PURE__ */ new O(), Ui = /* @__PURE__ */ new O(), er = /* @__PURE__ */ new O(), tr = /* @__PURE__ */ new O(), Nn = /* @__PURE__ */ new O();
...
const Xf = /* @__PURE__ */ new Yn(), Ni = /* @__PURE__ */ new O(), es = /* @__PURE__ */ new O();
class jn {
  ...
  setFromPoints(e, n) {
    const i = this.center;
    n !== void 0 ? i.copy(n) : Xf.setFromPoints(e).getCenter(i);
    let r = 0;
...
const sn = /* @__PURE__ */ new O(), ts = /* @__PURE__ */ new O(), nr = /* @__PURE__ */ new O(), xn = /* @__PURE__ */ new O(), ns = /* @__PURE__ */ new O(), ir = /* @__PURE__ */ new O(), is = /* @__PURE__ */ new O();
class Vr {
  ...
  distanceSqToSegment(e, n, i, r) {
    ts.copy(e).add(n).multiplyScalar(0.5), nr.copy(n).sub(e).normalize(), xn.copy(this.origin).sub(ts);
    const s = e.distanceTo(n) * 0.5, a = -this.direction.dot(nr), o = xn.dot(this.direction), c = -xn.dot(nr), l = xn.lengthSq(), h = Math.abs(1 - a * a);
    let f, d, u, _;
    if (h > 0)
  ...
  intersectTriangle(e, n, i, r, s) {
    ...
    const c = o * this.direction.dot(ir.crossVectors(xn, ir));
    if (c < 0)
      return null;
...
class Ke {
  ...
  lookAt(e, n, i) {
    ...
    return Dt.subVectors(e, n), Dt.lengthSq() === 0 && (Dt.z = 1), Dt.normalize(), Mn.crossVectors(i, Dt), Mn.lengthSq() === 0 && (Math.abs(i.z) === 1 ? Dt.x += 1e-4 : Dt.z += 1e-4, Dt.normalize(), Mn.crossVectors(i, Dt)), Mn.normalize(), rr.crossVectors(Dt, Mn), r[0] = Mn.x, r[4] = rr.x, r[8] = Dt.x, r[1] = Mn.y, r[5] = rr.y, r[9] = Dt.y, r[2] = Mn.z, r[6] = rr.z, r[10] = Dt.z, this;
  }
  multiply(e) {
    return this.multiplyMatrices(this, e);
  }
  ...
  multiplyMatrices(e, n) {
    const i = e.elements, r = n.elements, s = this.elements, a = i[0], o = i[4], c = i[8], l = i[12], h = i[1], f = i[5], d = i[9], u = i[13], _ = i[2], g = i[6], p = i[10], m = i[14], T = i[3], S = i[7], x = i[11], R = i[15], b = r[0], w = r[4], P = r[8], y = r[12], v = r[1], C = r[5], z = r[9], U = r[13], N = r[2], X = r[6], G = r[10], K = r[14], k = r[3], te = r[7], le = r[11], ve = r[15];
    return s[0] = a * b + o * v + c * N + l * k, s[4] = a * w + o * C + c * X + l * te, s[8] = a * P + o * z + c * G + l * le, s[12] = a * y + o * U + c * K + l * ve, s[1] = h * b + f * v + d * N + u * k, s[5] = h * w + f * C + d * X + u * te, s[9] = h * P + f * z + d * G + u * le, s[13] = h * y + f * U + d * K + u * ve, s[2] = _ * b + g * v + p * N + m * k, s[6] = _ * w + g * C + p * X + m * te, s[10] = _ * P + g * z + p * G + m * le, s[14] = _ * y + g * U + p * K + m * ve, s[3] = T * b + S * v + x * N + R * k, s[7] = T * w + S * C + x * X + R * te, s[11] = T * P + S * z + x * G + R * le, s[15] = T * y + S * U + x * K + R * ve, this;
  }
  multiplyScalar(e) {
    const n = this.elements;
...
const ii = /* @__PURE__ */ new O(), Gt = /* @__PURE__ */ new Ke(), qf = /* @__PURE__ */ new O(0, 0, 0), $f = /* @__PURE__ */ new O(1, 1, 1), Mn = /* @__PURE__ */ new O(), rr = /* @__PURE__ */ new O(), Dt = /* @__PURE__ */ new O(), lo = /* @__PURE__ */ new Ke(), ho = /* @__PURE__ */ new Dn();
class pn {
...
let Yf = 0;
const fo = /* @__PURE__ */ new O(), ri = /* @__PURE__ */ new Dn(), an = /* @__PURE__ */ new Ke(), sr = /* @__PURE__ */ new O(), Fi = /* @__PURE__ */ new O(), jf = /* @__PURE__ */ new O(), Zf = /* @__PURE__ */ new Dn(), uo = /* @__PURE__ */ new O(1, 0, 0), po = /* @__PURE__ */ new O(0, 1, 0), mo = /* @__PURE__ */ new O(0, 0, 1), _o = { type: "added" }, Kf = { type: "removed" }, si = { type: "childadded", child: null }, rs = { type: "childremoved", child: null };
class ut extends $n {
  constructor() {
    super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: Yf++ }), this.uuid = ji(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = ut.DEFAULT_UP.clone();
  ...
  lookAt(e, n, i) {
    ...
    const r = this.parent;
    this.updateWorldMatrix(!0, !1), Fi.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? an.lookAt(Fi, sr, this.up) : an.lookAt(sr, Fi, this.up), this.quaternion.setFromRotationMatrix(an), r && (an.extractRotation(r.matrixWorld), ri.setFromRotationMatrix(an), this.quaternion.premultiply(ri.invert()));
  }
  add(e) {
  ...
  remove(e) {
    ...
    return n !== -1 && (e.parent = null, this.children.splice(n, 1), e.dispatchEvent(Kf), rs.child = e, this.dispatchEvent(rs), rs.child = null), this;
  }
  removeFromParent() {
    const e = this.parent;
  ...
  getWorldQuaternion(e) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Fi, e, jf), e;
  }
  getWorldScale(e) {
    return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Fi, Zf, e), e;
  }
  getWorldDirection(e) {
...
class Xt {
  ...
  closestPointToPoint(e, n) {
    ...
    const m = 1 / (p + g + d);
    return a = g * m, o = d * m, n.copy(i).addScaledVector(ai, a).addScaledVector(oi, o);
  }
  equals(e) {
...
class Oe {
  ...
  setHSL(e, n, i, r = Ge.workingColorSpace) {
    if (e = Uf(e, 1), n = St(n, 0, 1), i = St(i, 0, 1), n === 0)
  ...
  lerpHSL(e, n) {
    this.getHSL(yn), e.getHSL(ar);
    const i = jr(yn.h, ar.h, n), r = jr(yn.s, ar.s, n), s = jr(yn.l, ar.l, n);
...
class Ri extends $n {
  ...
  constructor() {
    super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Jf++ }), this.uuid = ji(), this.name = "", this.blending = gi, this.side = Pn, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = ws, this.blendDst = Rs, this.blendEquation = Vn, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Oe(0, 0, 0), this.blendAlpha = 0, this.depthFunc = Mi, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = Qa, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Jn, this.stencilZFail = Jn, this.stencilZPass = Jn, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
let Qf = 0;
const Ft = /* @__PURE__ */ new Ke(), us = /* @__PURE__ */ new ut(), ci = /* @__PURE__ */ new O(), Lt = /* @__PURE__ */ new Yn(), Oi = /* @__PURE__ */ new Yn(), dt = /* @__PURE__ */ new O();
class pt extends $n {
  constructor() {
    super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: Qf++ }), this.uuid = ji(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = { start: 0, count: 1 / 0 }, this.userData = {};
  }
  getIndex() {
    return this.index;
  }
  ...
  computeTangents() {
    ...
    function m(P, y, v) {
      l.fromBufferAttribute(i, P), h.fromBufferAttribute(i, y), f.fromBufferAttribute(i, v), d.fromBufferAttribute(s, P), u.fromBufferAttribute(s, y), _.fromBufferAttribute(s, v), h.sub(l), f.sub(l), u.sub(d), _.sub(d);
      const C = 1 / (u.x * _.y - _.x * u.y);
      isFinite(C) && (g.copy(h).multiplyScalar(_.y).addScaledVector(f, -u.y).multiplyScalar(C), p.copy(f).multiplyScalar(u.x).addScaledVector(h, -_.x).multiplyScalar(C), o[P].add(g), o[y].add(g), o[v].add(g), c[P].add(p), c[y].add(p), c[v].add(p));
    }
    let T = this.groups;
    T.length === 0 && (T = [{
      start: 0,
    ...
    for (let P = 0, y = T.length; P < y; ++P) {
      const v = T[P], C = v.start, z = v.count;
      for (let U = C, N = C + z; U < N; U += 3)
        m(
          e.getX(U + 0),
          e.getX(U + 1),
          e.getX(U + 2)
    ...
    function w(P) {
      R.fromBufferAttribute(r, P), b.copy(R);
      const y = o[P];
      S.copy(y), S.sub(R.multiplyScalar(R.dot(y))).normalize(), x.crossVectors(b, y);
      const C = x.dot(c[P]) < 0 ? -1 : 1;
      a.setXYZW(P, S.x, S.y, S.z, C);
    }
    for (let P = 0, y = T.length; P < y; ++P) {
      const v = T[P], C = v.start, z = v.count;
      for (let U = C, N = C + z; U < N; U += 3)
...
const vo = /* @__PURE__ */ new Ke(), Fn = /* @__PURE__ */ new Vr(), cr = /* @__PURE__ */ new jn(), xo = /* @__PURE__ */ new O(), lr = /* @__PURE__ */ new O(), hr = /* @__PURE__ */ new O(), fr = /* @__PURE__ */ new O(), ps = /* @__PURE__ */ new O(), dr = /* @__PURE__ */ new O(), Mo = /* @__PURE__ */ new O(), ur = /* @__PURE__ */ new O();
class wt extends ut {
      ...
      if (Array.isArray(a))
        for (let _ = 0, g = d.length; _ < g; _++) {
          ...
          for (let x = T, R = S; x < R; x += 3) {
            ...
            r = pr(this, m, e, i, l, h, f, b, w, P), r && (r.faceIndex = Math.floor(x / 3), r.face.materialIndex = p.materialIndex, n.push(r));
          }
        }
      else {
...
function pr(t, e, n, i, r, s, a, o, c, l) {
  ...
  const h = ed(t, e, n, i, lr, hr, fr, Mo);
  if (h) {
    const f = new O();
...
class Zn extends pt {
  constructor(e = 1, n = 1, i = 1, r = 1, s = 1, a = 1) {
    ...
    function _(g, p, m, T, S, x, R, b, w, P, y) {
      const v = x / w, C = R / P, z = x / 2, U = R / 2, N = b / 2, X = w + 1, G = P + 1;
      let K = 0, k = 0;
      const te = new O();
      for (let le = 0; le < G; le++) {
        ...
        for (let Le = 0; Le < X; Le++) {
          const Xe = Le * v - z;
          te[g] = Xe * T, te[p] = ve * S, te[m] = N, l.push(te.x, te.y, te.z), te[g] = 0, te[p] = 0, te[m] = b > 0 ? 1 : -1, h.push(te.x, te.y, te.z), f.push(Le / w), f.push(1 - le / P), K += 1;
        }
      }
...
class Yt extends Ri {
  ...
  constructor(e) {
    super(), this.isShaderMaterial = !0, this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = id, this.fragmentShader = rd, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
      clipCullDistance: !1,
...
class ad extends qn {
  ...
  fromEquirectangularTexture(e, n) {
    ...
    return n.minFilter === Wn && (n.minFilter = Jt), new sd(1, 10, this).update(e, a), n.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
  }
  clear(e, n, i, r) {
...
const ms = /* @__PURE__ */ new O(), od = /* @__PURE__ */ new O(), cd = /* @__PURE__ */ new De();
class En {
  ...
  setFromCoplanarPoints(e, n, i) {
    const r = ms.subVectors(i, n).cross(od.subVectors(e, n)).normalize();
  ...
  applyMatrix4(e, n) {
    const i = n || cd.getNormalMatrix(e), r = this.coplanarPoint(ms).applyMatrix4(e), s = this.normal.applyMatrix3(i).normalize();
...
const On = /* @__PURE__ */ new jn(), mr = /* @__PURE__ */ new O();
class wa {
...
void main() {
  ...
  envmap_fragment: kd,
  envmap_common_pars_fragment: Gd,
...
const _r = { r: 0, b: 0, g: 0 }, zn = /* @__PURE__ */ new pn(), Gp = /* @__PURE__ */ new Ke();
function Wp(t, e, n, i, r, s, a) {
  const o = new Oe(0);
  ...
  function p(T, S) {
    const x = _(S);
    x && (x.isCubeTexture || x.mapping === Br) ? (h === void 0 && (h = new wt(
      new Zn(1, 1, 1),
      new Yt({
    ...
    }), r.update(h)), zn.copy(S.backgroundRotation), zn.x *= -1, zn.y *= -1, zn.z *= -1, x.isCubeTexture && x.isRenderTargetTexture === !1 && (zn.y *= -1, zn.z *= -1), h.material.uniforms.envMap.value = x, h.material.uniforms.flipEnvMap.value = x.isCubeTexture && x.isRenderTargetTexture === !1 ? -1 : 1, h.material.uniforms.backgroundBlurriness.value = S.backgroundBlurriness, h.material.uniforms.backgroundIntensity.value = S.backgroundIntensity, h.material.uniforms.backgroundRotation.value.setFromMatrix4(Gp.makeRotationFromEuler(zn)), h.material.toneMapped = Ge.getTransfer(x.colorSpace) !== je, (f !== x || d !== x.version || u !== t.toneMapping) && (h.material.needsUpdate = !0, f = x, d = x.version, u = t.toneMapping), h.layers.enableAll(), T.unshift(h, h.geometry, h.material, 0, 0, null)) : x && x.isTexture && (l === void 0 && (l = new wt(
      new kr(2, 2),
      new Yt({
...
function Xp(t, e) {
  ...
  let s = r, a = !1;
  function o(v, C, z, U, N) {
    let X = !1;
    const G = f(U, z, C);
    s !== G && (s = G, l(s.object)), X = u(v, U, z, N), X && _(v, U, z, N), N !== null && e.update(N, t.ELEMENT_ARRAY_BUFFER), (X || a) && (a = !1, x(v, C, z, U), N !== null && t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, e.get(N).buffer));
  }
  function c() {
  ...
  function m(v, C) {
    ...
    z[v] = 1, U[v] === 0 && (t.enableVertexAttribArray(v), U[v] = 1), N[v] !== C && (t.vertexAttribDivisor(v, C), N[v] = C);
  }
  function T() {
    const v = s.newAttributes, C = s.enabledAttributes;
    for (let z = 0, U = C.length; z < U; z++)
      C[z] !== v[z] && (t.disableVertexAttribArray(z), C[z] = 0);
  }
  function S(v, C, z, U, N, X, G) {
    G === !0 ? t.vertexAttribIPointer(v, C, z, N, X) : t.vertexAttribPointer(v, C, z, U, N, X);
  }
  function x(v, C, z, U) {
    g();
    const N = U.attributes, X = z.getAttributes(), G = C.defaultAttributeValues;
    for (const K in X) {
      const k = X[K];
      if (k.location >= 0) {
        let te = N[K];
...
function $p(t, e, n, i) {
  ...
  function o(w) {
    const P = w === Yi && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
...
const pi = 4, Eo = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582], kn = 20, _s = /* @__PURE__ */ new Oc(), To = /* @__PURE__ */ new Oe();
let gs = null, vs = 0, xs = 0, Ms = !1;
const Hn = (1 + Math.sqrt(5)) / 2, fi = 1 / Hn, bo = [
  /* @__PURE__ */ new O(-Hn, fi, 0),
  /* @__PURE__ */ new O(Hn, fi, 0),
  /* @__PURE__ */ new O(-fi, 0, Hn),
  /* @__PURE__ */ new O(fi, 0, Hn),
  /* @__PURE__ */ new O(0, Hn, -fi),
  /* @__PURE__ */ new O(0, Hn, fi),
...
class Ao {
  ...
  _allocateTargets() {
    ...
    if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== n) {
      ...
      ({ sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas } = Zp(s)), this._blurMaterial = Kp(s, e, n);
    }
    return r;
  }
  _compileMaterial(e) {
  ...
  _halfBlur(e, n, i, r, s, a, o) {
    ...
    const h = 3, f = new wt(this._lodPlanes[r], l), d = l.uniforms, u = this._sizeLods[i] - 1, _ = isFinite(s) ? Math.PI / (2 * u) : 2 * Math.PI / (2 * kn - 1), g = s / _, p = isFinite(s) ? 1 + Math.floor(h * g) : kn;
    p > kn && console.warn(`sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${kn}`);
    const m = [];
    let T = 0;
    for (let w = 0; w < kn; ++w) {
      const P = w / g, y = Math.exp(-P * P / 2);
    ...
    const x = this._sizeLods[r], R = 3 * x * (r > S - pi ? r - S + pi : 0), b = 4 * (this._cubeSize - x);
...
function Zp(t) {
  ...
  for (let a = 0; a < s; a++) {
    ...
    const R = new pt();
    R.setAttribute("position", new Bt(T, g)), R.setAttribute("uv", new Bt(S, p)), R.setAttribute("faceIndex", new Bt(x, m)), e.push(R), r > pi && r--;
  }
...
function Qp(t) {
  ...
  return {
    ...
    get: function(i) {
      const r = n(i);
      return r === null && Vi("THREE.WebGLRenderer: " + i + " extension not supported."), r;
    }
  };
}
function em(t, e, n, i) {
...
function im(t, e, n) {
  ...
  function s(a, o, c) {
    ...
    if (d === void 0 || d.count !== f) {
      ...
      const P = S * 4;
      for (let v = 0; v < f; v++) {
        const C = p[v], z = m[v], U = T[v], N = x * R * 4 * v;
        for (let X = 0; X < C.count; X++) {
          const G = X * P;
          u === !0 && (r.fromBufferAttribute(C, X), b[N + G + 0] = r.x, b[N + G + 1] = r.y, b[N + G + 2] = r.z, b[N + G + 3] = 0), _ === !0 && (r.fromBufferAttribute(z, X), b[N + G + 4] = r.x, b[N + G + 5] = r.y, b[N + G + 6] = r.z, b[N + G + 7] = 0), g === !0 && (r.fromBufferAttribute(U, X), b[N + G + 8] = r.x, b[N + G + 9] = r.y, b[N + G + 10] = r.z, b[N + G + 11] = U.itemSize === 4 ? r.w : 1);
        }
      }
      d = {
        count: f,
...
class zc extends xt {
  constructor(e, n, i, r, s, a, o, c, l, h = vi) {
    ...
    i === void 0 && h === vi && (i = Xn), i === void 0 && h === Ti && (i = Ei), super(null, r, s, a, o, c, h, i, l), this.isDepthTexture = !0, this.image = { width: e, height: n }, this.magFilter = o !== void 0 ? o : It, this.minFilter = c !== void 0 ? c : It, this.flipY = !1, this.generateMipmaps = !1, this.compareFunction = null;
  }
  copy(e) {
...
const Bc = /* @__PURE__ */ new xt(), Po = /* @__PURE__ */ new zc(1, 1), Hc = /* @__PURE__ */ new wc(), Vc = /* @__PURE__ */ new Wf(), kc = /* @__PURE__ */ new Nc(), Do = [], Lo = [], Io = new Float32Array(16), Uo = new Float32Array(9), No = new Float32Array(4);
function Pi(t, e, n) {
  const i = t[0];
  if (i <= 0 || i > 0) return t;
  const r = e * n;
...
class Xm {
  constructor(e, n, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = n.type, this.setValue = Tm(n.type);
  }
}
class qm {
  constructor(e, n, i) {
    this.id = e, this.addr = i, this.cache = [], this.type = n.type, this.size = n.size, this.setValue = Wm(n.type);
  }
}
class $m {
  constructor(e) {
...
function Ym(t, e, n) {
  ...
  for (ys.lastIndex = 0; ; ) {
    ...
    if (c && (o = o | 0), l === void 0 || l === "[" && a + 2 === r) {
      Fo(n, l === void 0 ? new Xm(o, t, e) : new qm(o, t, e));
      break;
    } else {
      let f = n.map[o];
      f === void 0 && (f = new $m(o), Fo(n, f)), n = f;
    }
  }
}
class Dr {
...
function h0(t) {
  ...
  return t.shadowMapType === dc ? e = "SHADOWMAP_TYPE_PCF" : t.shadowMapType === $h ? e = "SHADOWMAP_TYPE_PCF_SOFT" : t.shadowMapType === hn && (e = "SHADOWMAP_TYPE_VSM"), e;
}
function f0(t) {
...
function m0(t, e, n, i) {
  ...
  const c = h0(n), l = f0(n), h = d0(n), f = u0(n), d = p0(n), u = n0(n), _ = i0(s), g = r.createProgram();
...
`), m = [
    ...
    n.toneMapping !== Cn ? e0("toneMapping", n.toneMapping) : "",
...
` + k
    ...
    r.deleteShader(R), r.deleteShader(b), P = new Dr(r, g), y = r0(r, g);
  }
  let P;
  ...
  return this.isReady = function() {
    return v === !1 && (v = r.getProgramParameter(g, jm)), v;
  }, this.destroy = function() {
    i.releaseStatesOfProgram(this), r.deleteProgram(g), this.program = void 0;
  }, this.type = n.shaderType, this.name = n.shaderName, this.id = Zm++, this.cacheKey = e, this.usedTimes = 1, this.program = g, this.vertexShader = R, this.fragmentShader = b, this;
}
let _0 = 0;
class g0 {
  constructor() {
  ...
  _getShaderStage(e) {
    ...
    let i = n.get(e);
    return i === void 0 && (i = new v0(e), n.set(e, i)), i;
  }
}
class v0 {
  constructor(e) {
...
function x0(t, e, n, i, r, s, a) {
  const o = new Rc(), c = new g0(), l = /* @__PURE__ */ new Set(), h = [], f = r.logarithmicDepthBuffer, d = r.vertexTextures;
  let u = r.precision;
  const _ = {
  ...
  function p(y, v, C, z, U) {
    ...
    const mt = {
      ...
      outputColorSpace: ie === null ? t.outputColorSpace : ie.isXRRenderTarget === !0 ? ie.texture.colorSpace : wi,
      ...
      emissiveMap: et,
      normalMapObjectSpace: Be && y.normalMapType === Af,
      normalMapTangentSpace: Be && y.normalMapType === bf,
      metalnessMap: ye,
      roughnessMap: A,
      anisotropy: M,
      anisotropyMap: se,
  ...
  function R(y, v) {
    ...
    return C === void 0 && (C = new m0(t, v, y, s), h.push(C)), C;
  }
  function b(y) {
    if (--y.usedTimes === 0) {
      const v = h.indexOf(y);
...
function Xo() {
  ...
  function l(f, d) {
    n.length > 1 && n.sort(f || y0), i.length > 1 && i.sort(d || Wo), r.length > 1 && r.sort(d || Wo);
  }
  function h() {
...
function w0(t) {
  ...
  function o(l) {
    ...
    for (let y = 0, v = l.length; y < v; y++) {
      const C = l[y], z = C.color, U = C.intensity, N = C.distance, X = C.shadow && C.shadow.map ? C.shadow.map.texture : null;
      if (C.isAmbientLight)
        h += z.r * U, f += z.g * U, d += z.b * U;
      else if (C.isLightProbe) {
        for (let G = 0; G < 9; G++)
          i.probe[G].addScaledVector(C.sh.coefficients[G], U);
        w++;
      } else if (C.isDirectionalLight) {
        const G = e.get(C);
        if (G.color.copy(C.color).multiplyScalar(C.intensity), C.castShadow) {
          const K = C.shadow, k = n.get(C);
          k.shadowIntensity = K.intensity, k.shadowBias = K.bias, k.shadowNormalBias = K.normalBias, k.shadowRadius = K.radius, k.shadowMapSize = K.mapSize, i.directionalShadow[u] = k, i.directionalShadowMap[u] = X, i.directionalShadowMatrix[u] = C.shadow.matrix, T++;
        }
        i.directional[u] = G, u++;
      } else if (C.isSpotLight) {
        const G = e.get(C);
        G.position.setFromMatrixPosition(C.matrixWorld), G.color.copy(z).multiplyScalar(U), G.distance = N, G.coneCos = Math.cos(C.angle), G.penumbraCos = Math.cos(C.angle * (1 - C.penumbra)), G.decay = C.decay, i.spot[g] = G;
        const K = C.shadow;
        if (C.map && (i.spotLightMap[R] = C.map, R++, K.updateMatrices(C), C.castShadow && b++), i.spotLightMatrix[g] = K.matrix, C.castShadow) {
          const k = n.get(C);
        ...
        const G = e.get(C);
        G.color.copy(z).multiplyScalar(U), G.halfWidth.set(C.width * 0.5, 0, 0), G.halfHeight.set(0, C.height * 0.5, 0), i.rectArea[p] = G, p++;
        ...
        const G = e.get(C);
        G.skyColor.copy(C.color).multiplyScalar(U), G.groundColor.copy(C.groundColor).multiplyScalar(U), i.hemi[m] = G, m++;
      }
    }
...
class C0 extends Ri {
  ...
  constructor(e) {
    super(), this.isMeshDepthMaterial = !0, this.depthPacking = Ef, this.map = null, this.alphaMap = null, this.displacementMap = null, this.displacementScale = 1, this.displacementBias = 0, this.wireframe = !1, this.wireframeLinewidth = 1, this.setValues(e);
  }
  copy(e) {
...
function I0(t, e, n) {
  let i = new wa();
  const r = new we(), s = new we(), a = new st(), o = new C0({ depthPacking: Tf }), c = new P0(), l = {}, h = n.maxTextureSize, f = { [Pn]: Ct, [Ct]: Pn, [Kt]: Kt }, d = new Yt({
    defines: {
      VSM_SAMPLES: 8
    },
    uniforms: {
  ...
  this.render = function(b, w, P) {
    ...
    const y = t.getRenderTarget(), v = t.getActiveCubeFace(), C = t.getActiveMipmapLevel(), z = t.state;
    ...
    for (let X = 0, G = b.length; X < G; X++) {
      ...
      k.isPointLightShadow !== !0 && this.type === hn && T(k, P), k.needsUpdate = !1;
    }
    m = this.type, p.needsUpdate = !1, t.setRenderTarget(y, v, C);
  };
  function T(b, w) {
    const P = e.update(g);
  ...
  function S(b, w, P, y) {
    let v = null;
    const C = P.isPointLight === !0 ? b.customDistanceMaterial : b.customDepthMaterial;
    if (C !== void 0)
      v = C;
    ...
    if (b.layers.test(w.layers) && (b.isMesh || b.isLine || b.isPoints) && (b.castShadow || b.receiveShadow && v === hn) && (!b.frustumCulled || i.intersectsObject(b))) {
      ...
      if (Array.isArray(N)) {
        ...
        for (let G = 0, K = X.length; G < K; G++) {
          ...
          if (te && te.visible) {
            const le = S(b, te, y, v);
            b.onBeforeShadow(t, b, w, P, U, le, k), t.renderBufferDirect(P, null, U, le, b, k), b.onAfterShadow(t, b, w, P, U, le, k);
          }
        }
      } else if (N.visible) {
        const X = S(b, N, y, v);
        b.onBeforeShadow(t, b, w, P, U, X, null), t.renderBufferDirect(P, null, U, X, b, null), b.onAfterShadow(t, b, w, P, U, X, null);
      }
    }
    const z = b.children;
...
function N0(t, e) {
  ...
  let h = {}, f = {}, d = /* @__PURE__ */ new WeakMap(), u = [], _ = null, g = !1, p = null, m = null, T = null, S = null, x = null, R = null, b = null, w = new Oe(0, 0, 0), P = 0, y = !1, v = null, C = null, z = null, U = null, N = null;
  ...
  const Ve = {
    [Vn]: t.FUNC_ADD,
    [jh]: t.FUNC_SUBTRACT,
    [Zh]: t.FUNC_REVERSE_SUBTRACT
  };
  Ve[Kh] = t.MIN, Ve[Jh] = t.MAX;
  const at = {
    [Qh]: t.ZERO,
    [ef]: t.ONE,
    [tf]: t.SRC_COLOR,
    [ws]: t.SRC_ALPHA,
    [cf]: t.SRC_ALPHA_SATURATE,
    [af]: t.DST_COLOR,
    [rf]: t.DST_ALPHA,
    [nf]: t.ONE_MINUS_SRC_COLOR,
    [Rs]: t.ONE_MINUS_SRC_ALPHA,
    [of]: t.ONE_MINUS_DST_COLOR,
    [sf]: t.ONE_MINUS_DST_ALPHA,
    [lf]: t.CONSTANT_COLOR,
    [hf]: t.ONE_MINUS_CONSTANT_COLOR,
    [ff]: t.CONSTANT_ALPHA,
    [df]: t.ONE_MINUS_CONSTANT_ALPHA
  };
  function F(D, re, W, j, ce, ae, Ce, rt, mt, Ye) {
    ...
    if (g === !1 && (ie(t.BLEND), g = !0), D !== Yh) {
      if (D !== p || Ye !== y) {
        ...
        T = null, S = null, R = null, b = null, w.set(0, 0, 0), P = 0, p = D, y = Ye;
      }
      return;
    }
    ce = ce || re, ae = ae || W, Ce = Ce || j, (re !== m || ce !== x) && (t.blendEquationSeparate(Ve[re], Ve[ce]), m = re, x = ce), (W !== T || j !== S || ae !== R || Ce !== b) && (t.blendFuncSeparate(at[W], at[j], at[ae], at[Ce]), T = W, S = j, R = ae, b = Ce), (rt.equals(w) === !1 || mt !== P) && (t.blendColor(rt.r, rt.g, rt.b, mt), w.copy(rt), P = mt), p = D, y = !1;
  }
  function Ut(D, re) {
  ...
  function Be(D) {
    D !== Xh ? (ie(t.CULL_FACE), D !== C && (D === ja ? t.cullFace(t.BACK) : D === qh ? t.cullFace(t.FRONT) : t.cullFace(t.FRONT_AND_BACK))) : Se(t.CULL_FACE), C = D;
  }
  function Ee(D) {
...
function O0(t, e, n, i, r, s, a) {
  ...
  function x(A, M) {
    let B;
    return A ? M === null || M === Xn || M === Ei ? B = t.DEPTH24_STENCIL8 : M === Qt ? B = t.DEPTH32F_STENCIL8 : M === Wi && (B = t.DEPTH24_STENCIL8, console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : M === null || M === Xn || M === Ei ? B = t.DEPTH_COMPONENT24 : M === Qt ? B = t.DEPTH_COMPONENT32F : M === Wi && (B = t.DEPTH_COMPONENT16), B;
  }
  function R(A, M) {
  ...
  function q(A, M, B) {
    ...
    if ($.version !== xe.__version || Z === !0) {
      ...
      if (M.isDepthTexture)
        be = x(M.format === Ti, M.type), Je && (Ie ? n.texStorage2D(t.TEXTURE_2D, 1, be, J.width, J.height) : n.texImage2D(t.TEXTURE_2D, 0, be, J.width, J.height, 0, de, Te, null));
  ...
  function et(A, M) {
    ...
    return A.isCompressedTexture === !0 || A.isVideoTexture === !0 || B !== wi && B !== wn && (Ge.getTransfer(B) === je ? (Y !== qt || Z !== un) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", B)), M;
  }
  function ye(A) {
...
class Ss {
  ...
  update(e, n, i) {
    ...
    if (e && n.session.visibilityState !== "visible-blurred") {
      ...
      o !== null && (r = n.getPose(e.targetRaySpace, i), r === null && s !== null && (r = s), r !== null && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = !0, r.linearVelocity ? (o.hasLinearVelocity = !0, o.linearVelocity.copy(r.linearVelocity)) : o.hasLinearVelocity = !1, r.angularVelocity ? (o.hasAngularVelocity = !0, o.angularVelocity.copy(r.angularVelocity)) : o.hasAngularVelocity = !1, this.dispatchEvent(H0)));
    }
...
class W0 extends $n {
  constructor(e, n) {
    ...
    const g = new G0(), p = n.getContextAttributes();
    let m = null, T = null;
    const S = [], x = [], R = new we();
    let b = null;
    const w = new zt();
    ...
    function N() {
      ...
      C = null, z = null, g.reset(), e.setRenderTarget(m), u = null, d = null, f = null, r = null, T = null, Xe.stop(), i.isPresenting = !1, e.setPixelRatio(b), e.setSize(R.width, R.height, !1), i.dispatchEvent({ type: "sessionend" });
    }
    this.setFramebufferScaleFactor = function(q) {
      ...
      if (r = q, r !== null) {
        if (m = e.getRenderTarget(), r.addEventListener("select", U), r.addEventListener("selectstart", U), r.addEventListener("selectend", U), r.addEventListener("squeeze", U), r.addEventListener("squeezestart", U), r.addEventListener("squeezeend", U), r.addEventListener("end", N), r.addEventListener("inputsourceschange", X), p.xrCompatible !== !0 && await n.makeXRCompatible(), b = e.getPixelRatio(), e.getSize(R), r.renderState.layers === void 0) {
          ...
          p.depth && (ie = p.stencil ? n.DEPTH24_STENCIL8 : n.DEPTH_COMPONENT24, Q = p.stencil ? Ti : vi, he = p.stencil ? Ei : Xn);
          const Se = {
            colorFormat: n.RGBA8,
            depthFormat: ie,
            scaleFactor: s
    ...
    this.updateCamera = function(q) {
      ...
      g.texture !== null && (g.depthNear > 0 && (Q = g.depthNear), g.depthFar > 0 && (he = g.depthFar)), v.near = P.near = w.near = Q, v.far = P.far = w.far = he, (C !== v.near || z !== v.far) && (r.updateRenderState({
        depthNear: v.near,
        depthFar: v.far
      }), C = v.near, z = v.far), w.layers.mask = q.layers.mask | 2, P.layers.mask = q.layers.mask | 4, v.layers.mask = w.layers.mask | P.layers.mask;
...
const Bn = /* @__PURE__ */ new pn(), X0 = /* @__PURE__ */ new Ke();
function q0(t, e) {
  function n(p, m) {
  ...
  function d(T) {
    ...
    for (let b = 0, w = x.length; b < w; b++) {
      ...
      for (let y = 0, v = P.length; y < v; y++) {
        const C = P[y];
        if (u(C, b, y, R) === !0) {
          const z = C.__offset, U = Array.isArray(C.value) ? C.value : [C.value];
          let N = 0;
...
class Y0 {
  constructor(e = {}) {
    ...
    const x = this;
    let R = !1, b = 0, w = 0, P = null, y = -1, v = null;
    ...
    function re() {
      ze = new Qp(F), ze.init(), Ie = new z0(F, ze), Be = new $p(F, ze, e, Ie), Ee = new N0(F, ze), Be.reverseDepthBuffer && d && Ee.buffers.depth.setReversed(!0), et = new nm(F), ye = new M0(), A = new O0(F, ze, Ee, ye, Be, Ie, et), M = new jp(x), B = new Jp(x), Y = new ld(F), Je = new Xp(F, Y), Z = new em(F, Y, et, Je), $ = new rm(F, Z, Y, et), be = new im(F, Be, A), J = new Yp(ye), xe = new x0(x, M, B, ze, Be, Je, J), se = new q0(x, ye), fe = new S0(), ke = new R0(ze), Te = new Wp(x, M, B, Ee, $, u, c), de = new I0(x, $, Be), D = new $0(F, et, Be, Ee), ue = new qp(F, ze, et), He = new tm(F, ze, et), et.programs = xe.programs, x.capabilities = Be, x.extensions = ze, x.properties = ye, x.renderLists = fe, x.shadowMap = de, x.state = Ee, x.info = et;
    }
    re();
    const W = new W0(x, F);
    this.xr = W, this.getContext = function() {
      ...
      if (E) {
        ...
        if (I) {
          const ee = P.texture.type, oe = ee === un || ee === Xn || ee === Wi || ee === Ei || ee === ya || ee === Sa, me = Te.getClearColor(), _e = Te.getClearAlpha(), Ae = me.r, Pe = me.g, ge = me.b;
    ...
    this.renderBufferDirect = function(E, L, H, V, I, ee) {
      ...
      let Et, qe = ue;
      if (_e !== null && (Et = Y.get(_e), qe = He, qe.setIndex(Et)), I.isMesh)
      ...
      if (I.isBatchedMesh)
        if (I._multiDrawInstances !== null)
          ...
          const Me = I._multiDrawStarts, nn = I._multiDrawCounts, $e = I._multiDrawCount, Vt = _e ? Y.get(_e).bytesPerElement : 1, Kn = ye.get(V).currentProgram.getUniforms();
          for (let Pt = 0; Pt < $e; Pt++)
            Kn.setValue(F, "_gl_DrawID", Pt), qe.render(Me[Pt] / Vt, nn[Pt]);
        }
    ...
    function Ye(E, L, H) {
      E.transparent === !0 && E.side === Kt && E.forceSinglePass === !1 ? (E.side = Ct, E.needsUpdate = !0, Ki(E, L, H), E.side = Pn, E.needsUpdate = !0, Ki(E, L, H), E.side = Kt) : Ki(E, L, H);
    }
    ...
    In.setAnimationLoop(tn), typeof self < "u" && In.setContext(self), this.setAnimationLoop = function(E) {
      ...
      P !== null && (A.updateMultisampleRenderTarget(P), A.updateRenderTargetMipmap(P)), E.isScene === !0 && E.onAfterRender(x, E, L), Je.resetDefaultState(), y = -1, v = null, S.pop(), S.length > 0 ? (m = S[S.length - 1], Q === !0 && J.setGlobalState(x.clippingPlanes, m.state.camera)) : m = null, T.pop(), T.length > 0 ? p = T[T.length - 1] : p = null;
    };
    function $r(E, L, H, V) {
    ...
    function Ga(E, L, H, V) {
      ...
      m.setupLightsView(H), Q === !0 && J.setGlobalState(x.clippingPlanes, H), V && Ee.viewport(C.copy(V)), I.length > 0 && Zi(I, L, H), ee.length > 0 && Zi(ee, L, H), oe.length > 0 && Zi(oe, L, H), Ee.buffers.depth.setTest(!0), Ee.buffers.depth.setMask(!0), Ee.buffers.color.setMask(!0), Ee.setPolygonOffset(!1);
    }
    function Wa(E, L, H, V) {
      ...
      const ee = m.state.transmissionRenderTarget[V.id], oe = V.viewport || C;
      ...
      if (V.viewport !== void 0 && (V.viewport = void 0), m.setupLightsView(V), Q === !0 && J.setGlobalState(x.clippingPlanes, V), Zi(E, H, V), A.updateMultisampleRenderTarget(ee), A.updateRenderTargetMipmap(ee), ze.has("WEBGL_multisampled_render_to_texture") === !1) {
        ...
        for (let ge = 0, We = L.length; ge < We; ge++) {
          ...
          if (qe.side === Kt && tt.layers.test(V.layers)) {
            const nn = qe.side;
            qe.side = Ct, qe.needsUpdate = !0, Xa(tt, H, V, Et, qe, Me), qe.side = nn, qe.needsUpdate = !0, Pe = !0;
          }
        }
    ...
    function Xa(E, L, H, V, I, ee) {
      E.onBeforeRender(x, L, H, V, I, ee), E.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse, E.matrixWorld), E.normalMatrix.getNormalMatrix(E.modelViewMatrix), I.onBeforeRender(x, L, H, V, E, ee), I.transparent === !0 && I.side === Kt && I.forceSinglePass === !1 ? (I.side = Ct, I.needsUpdate = !0, x.renderBufferDirect(H, L, V, I, E, ee), I.side = Pn, I.needsUpdate = !0, x.renderBufferDirect(H, L, V, I, E, ee), I.side = Kt) : x.renderBufferDirect(H, L, V, I, E, ee), E.onAfterRender(x, L, H, V, I, ee);
    }
    function Ki(E, L, H) {
      L.isScene !== !0 && (L = it);
    ...
    function mh(E, L, H, V, I) {
      ...
      let tt = Cn;
      V.toneMapped && (P === null || P.isXRRenderTarget === !0) && (tt = x.toneMapping);
      const Et = H.morphAttributes.position || H.morphAttributes.normal || H.morphAttributes.color, qe = Et !== void 0 ? Et.length : 0, Me = ye.get(V), nn = m.state.lights;
      if (Q === !0 && (he === !0 || E !== v)) {
        const Nt = E === v && V.id === y;
        J.setState(V, E, Nt);
      }
      ...
      if (Ee.useProgram(Vt.program) && (Kn = !0, Pt = !0, Di = !0), V.id !== y && (y = V.id, Pt = !0), Kn || v !== E) {
        Ee.buffers.depth.getReversed() ? (ie.copy(E.projectionMatrix), zf(ie), Bf(ie), nt.setValue(F, "projectionMatrix", ie)) : nt.setValue(F, "projectionMatrix", E.projectionMatrix), nt.setValue(F, "viewMatrix", E.matrixWorldInverse);
        ...
        ), (V.isMeshPhongMaterial || V.isMeshToonMaterial || V.isMeshLambertMaterial || V.isMeshBasicMaterial || V.isMeshStandardMaterial || V.isShaderMaterial) && nt.setValue(F, "isOrthographic", E.isOrthographicCamera === !0), v !== E && (v = E, Pt = !0, Di = !0);
      }
      if (I.isSkinnedMesh) {
      ...
      if ((Li.position !== void 0 || Li.normal !== void 0 || Li.color !== void 0) && be.update(I, H, Vt), (Pt || Me.receiveShadow !== I.receiveShadow) && (Me.receiveShadow = I.receiveShadow, nt.setValue(F, "receiveShadow", I.receiveShadow)), V.isMeshGouraudMaterial && V.envMap !== null && (jt.envMap.value = _e, jt.flipEnvMap.value = _e.isCubeTexture && _e.isRenderTargetTexture === !1 ? -1 : 1), V.isMeshStandardMaterial && V.envMap === null && L.environment !== null && (jt.envMapIntensity.value = L.environmentIntensity), Pt && (nt.setValue(F, "toneMappingExposure", x.toneMappingExposure), Me.needsLights && _h(jt, Di), ee && V.fog === !0 && se.refreshFogUniforms(jt, ee), se.refreshMaterialUniforms(jt, V, k, K, m.state.transmissionRenderTarget[E.id]), Dr.upload(F, qa(Me), jt, A)), V.isShaderMaterial && V.uniformsNeedUpdate === !0 && (Dr.upload(F, qa(Me), jt, A), V.uniformsNeedUpdate = !1), V.isSpriteMaterial && nt.setValue(F, "center", I.center), nt.setValue(F, "modelViewMatrix", I.modelViewMatrix), nt.setValue(F, "normalMatrix", I.normalMatrix), nt.setValue(F, "modelMatrix", I.matrixWorld), V.isShaderMaterial || V.isRawShaderMaterial) {
    ...
    this.getActiveCubeFace = function() {
      ...
      if (E) {
        ...
        E.isWebGLCubeRenderTarget ? (Array.isArray(Pe[L]) ? I = Pe[L][H] : I = Pe[L], ee = !0) : E.samples > 0 && A.useMultisampledRTT(E) === !1 ? I = ye.get(E).__webglMultisampledFramebuffer : Array.isArray(Pe) ? I = Pe[H] : I = Pe, C.copy(E.viewport), z.copy(E.scissor), U = E.scissorTest;
      } else
        C.copy(ve).multiplyScalar(k).floor(), z.copy(Le).multiplyScalar(k).floor(), U = Xe;
      if (Ee.bindFramebuffer(F.FRAMEBUFFER, I) && V && Ee.drawBuffers(E, I), Ee.viewport(C), Ee.scissor(z), Ee.setScissorTest(U), ee) {
      ...
      if (E.isWebGLCubeRenderTarget && oe !== void 0 && (me = me[oe]), me) {
        ...
        if (L >= 0 && L <= E.width - V && H >= 0 && H <= E.height - I) {
          ...
          return F.flush(), await Of(F, Qe, 4), F.bindBuffer(F.PIXEL_PACK_BUFFER, ge), F.getBufferSubData(F.PIXEL_PACK_BUFFER, 0, ee), F.deleteBuffer(ge), F.deleteSync(Qe), ee;
        } else
          throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.");
      }
    }, this.copyFramebufferToTexture = function(E, L = null, H = 0) {
      E.isTexture !== !0 && (Vi("WebGLRenderer: copyFramebufferToTexture function signature has changed."), L = arguments[0] || null, E = arguments[1]);
      ...
      E.isTexture !== !0 && (Vi("WebGLRenderer: copyTextureToTexture function signature has changed."), V = arguments[0] || null, E = arguments[1], L = arguments[2], I = arguments[3] || 0, H = null);
      ...
      const nn = F.getParameter(F.UNPACK_ROW_LENGTH), $e = F.getParameter(F.UNPACK_IMAGE_HEIGHT), Vt = F.getParameter(F.UNPACK_SKIP_PIXELS), Kn = F.getParameter(F.UNPACK_SKIP_ROWS), Pt = F.getParameter(F.UNPACK_SKIP_IMAGES);
      ...
      const Di = E.isDataArrayTexture || E.isData3DTexture, nt = L.isDataArrayTexture || L.isData3DTexture;
      if (E.isRenderTargetTexture || E.isDepthTexture) {
        const jt = ye.get(E), Li = ye.get(L), Nt = ye.get(jt.__renderTarget), mn = ye.get(Li.__renderTarget);
        ...
        for (let _n = 0; _n < me; _n++)
          Di && F.framebufferTextureLayer(F.READ_FRAMEBUFFER, F.COLOR_ATTACHMENT0, ye.get(E).__webglTexture, I, Pe + _n), E.isDepthTexture ? (nt && F.framebufferTextureLayer(F.DRAW_FRAMEBUFFER, F.COLOR_ATTACHMENT0, ye.get(L).__webglTexture, I, Qe + _n), F.blitFramebuffer(_e, Ae, ee, oe, ge, We, ee, oe, F.DEPTH_BUFFER_BIT, F.NEAREST)) : nt ? F.copyTexSubImage3D(Me, I, ge, We, Qe + _n, _e, Ae, ee, oe) : F.copyTexSubImage2D(Me, I, ge, We, Qe + _n, _e, Ae, ee, oe);
        Ee.bindFramebuffer(F.READ_FRAMEBUFFER, null), Ee.bindFramebuffer(F.DRAW_FRAMEBUFFER, null);
      } else
        nt ? E.isDataTexture || E.isData3DTexture ? F.texSubImage3D(Me, I, ge, We, Qe, ee, oe, me, Et, qe, tt.data) : L.isCompressedArrayTexture ? F.compressedTexSubImage3D(Me, I, ge, We, Qe, ee, oe, me, Et, tt.data) : F.texSubImage3D(Me, I, ge, We, Qe, ee, oe, me, Et, qe, tt) : E.isDataTexture ? F.texSubImage2D(F.TEXTURE_2D, I, ge, We, ee, oe, Et, qe, tt.data) : E.isCompressedTexture ? F.compressedTexSubImage2D(F.TEXTURE_2D, I, ge, We, tt.width, tt.height, Et, tt.data) : F.texSubImage2D(F.TEXTURE_2D, I, ge, We, ee, oe, Et, qe, tt);
      F.pixelStorei(F.UNPACK_ROW_LENGTH, nn), F.pixelStorei(F.UNPACK_IMAGE_HEIGHT, $e), F.pixelStorei(F.UNPACK_SKIP_PIXELS, Vt), F.pixelStorei(F.UNPACK_SKIP_ROWS, Kn), F.pixelStorei(F.UNPACK_SKIP_IMAGES, Pt), I === 0 && L.generateMipmaps && F.generateMipmap(Me), Ee.unbindTexture();
    }, this.copyTextureToTexture3D = function(E, L, H = null, V = null, I = 0) {
      return E.isTexture !== !0 && (Vi("WebGLRenderer: copyTextureToTexture3D function signature has changed."), H = arguments[0] || null, V = arguments[1] || null, E = arguments[2], L = arguments[3], I = arguments[4] || 0), Vi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'), this.copyTextureToTexture(E, L, H, V, I);
      ...
      b = 0, w = 0, P = null, Ee.reset(), Je.reset();
...
const di = /* @__PURE__ */ new Ke(), jo = /* @__PURE__ */ new Ke(), xr = [], Zo = /* @__PURE__ */ new Yn(), K0 = /* @__PURE__ */ new Ke(), zi = /* @__PURE__ */ new wt(), Bi = /* @__PURE__ */ new jn();
class Gc extends wt {
  constructor(e, n, i) {
  ...
  computeBoundingSphere() {
    ...
    for (let i = 0; i < n; i++)
      this.getMatrixAt(i, di), Bi.copy(e.boundingSphere).applyMatrix4(di), this.boundingSphere.union(Bi);
  }
  copy(e, n) {
  ...
  raycast(e, n) {
    ...
    if (zi.geometry = this.geometry, zi.material = this.material, zi.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(), Bi.copy(this.boundingSphere), Bi.applyMatrix4(i), e.ray.intersectsSphere(Bi) !== !1))
      for (let s = 0; s < r; s++) {
        this.getMatrixAt(s, di), jo.multiplyMatrices(i, di), zi.matrixWorld = jo, zi.raycast(e, xr);
  ...
  setMorphAt(e, n) {
    ...
    this.morphTexture === null && (this.morphTexture = new Z0(new Float32Array(r * this.count), r, this.count, Ea, Qt));
...
const Nr = /* @__PURE__ */ new O(), Fr = /* @__PURE__ */ new O(), Ko = /* @__PURE__ */ new Ke(), Hi = /* @__PURE__ */ new Vr(), Mr = /* @__PURE__ */ new jn(), Es = /* @__PURE__ */ new O(), Jo = /* @__PURE__ */ new O();
class Or extends ut {
  ...
  raycast(e, n) {
    ...
    Ko.copy(r).invert(), Hi.copy(e.ray).applyMatrix4(Ko);
    ...
    if (h !== null) {
      ...
      for (let g = u, p = _ - 1; g < p; g += l) {
        const m = h.getX(g), T = h.getX(g + 1), S = yr(this, e, Hi, c, m, T);
        S && n.push(S);
      }
      if (this.isLineLoop) {
        const g = h.getX(_ - 1), p = h.getX(u), m = yr(this, e, Hi, c, g, p);
        m && n.push(m);
      }
    } else {
      const u = Math.max(0, a.start), _ = Math.min(d.count, a.start + a.count);
      for (let g = u, p = _ - 1; g < p; g += l) {
        const m = yr(this, e, Hi, c, g, g + 1);
        m && n.push(m);
      }
      if (this.isLineLoop) {
        const g = yr(this, e, Hi, c, _ - 1, u);
        g && n.push(g);
      }
    }
  }
...
const Qo = /* @__PURE__ */ new Ke(), pa = /* @__PURE__ */ new Vr(), Sr = /* @__PURE__ */ new jn(), Er = /* @__PURE__ */ new O();
class Wc extends ut {
  constructor(e = new pt(), n = new J0()) {
...
class Ca extends pt {
  constructor(e = 1, n = 1, i = 1, r = 32, s = 1, a = !1, o = 0, c = Math.PI * 2) {
    ...
    function T() {
      ...
      const w = (n - e) / i;
      for (let P = 0; P <= s; P++) {
        const y = [], v = P / s, C = v * (n - e) + e;
        for (let z = 0; z <= r; z++) {
          const U = z / r, N = U * c + o, X = Math.sin(N), G = Math.cos(N);
          R.x = C * X, R.y = -v * i + p, R.z = C * G, f.push(R.x, R.y, R.z), x.set(X, w, G).normalize(), d.push(x.x, x.y, x.z), u.push(U, 1 - v), y.push(_++);
        }
        g.push(y);
      }
      for (let P = 0; P < r; P++)
        for (let y = 0; y < s; y++) {
          const v = g[y][P], C = g[y + 1][P], z = g[y + 1][P + 1], U = g[y][P + 1];
          (e > 0 || y !== 0) && (h.push(v, C, U), b += 3), (n > 0 || y !== s - 1) && (h.push(C, z, U), b += 3);
        }
    ...
    function S(x) {
      ...
      for (let z = 0; z < r; z++) {
        const U = R + z, N = C + z;
        x === !0 ? h.push(N, N + 1, U) : h.push(N + 1, N, U), P += 3;
      }
      l.addGroup(m, P, x === !0 ? 1 : 2), m += P;
    }
  }
  copy(e) {
    return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
...
const e_ = /* @__PURE__ */ new Q0();
class Pa {
  constructor(e) {
    this.manager = e !== void 0 ? e : e_, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {};
  }
  load() {
  }
  loadAsync(e, n) {
...
class Xc extends Pa {
  ...
  load(e, n, i, r) {
    const s = new xt(), a = new t_(this.manager);
...
class r_ extends qc {
  constructor(e, n) {
    super(e, n), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(ut.DEFAULT_UP), this.updateMatrix(), this.target = new ut(), this.shadow = new i_();
  }
  dispose() {
    this.shadow.dispose();
  }
...
const $c = 2, f_ = new we(800, 700);
function d_(t, e, n, i = $c, r) {
  if (t.points.length < 2) {
    const c = new pt();
    return new wt(c, new Ci({ color: n }));
  }
...
function Yc(t, e, n, i = $c, r) {
  const s = u_(i), a = new vt();
  for (const o of t.values())
    !(o != null && o.points) || o.points.length < 2 || a.add(d_(o, e, n, s));
  return a;
}
const jc = `
...
function p_(t, e = 1, n = 1, i = 16777215, r = 1) {
...
function m_(t, e = 1, n = 16777215, i = 0.4) {
...
function v_(t, e, n, i = 16777215, r = 5) {
...
function el(t, e = 1, n = 16777215, i = 10) {
  const r = t.size, s = Array.from(t.entries()), a = typeof i == "number" ? Array(r).fill(i) : i, o = new Zn(1, 1, 1), c = new Ci({ color: n }), l = new Gc(o, c, r);
...
function x_(t, e = 1, n = 16777215, i = 10) {
  const r = t.get_node_ids_order(), s = r.length, a = t.get_position_map(), o = typeof i == "number" ? Array(s).fill(i) : i, c = new Zn(1, 1, 1), l = new Ci({ color: n }), h = new Gc(c, l, s);
...
function y_(t, e = 16, n = 16777215, i = 10) {
  let r;
...
const _y = {
  ...
  DrawTHREEGraphVerticesMutable: p_,
  DrawTHREEGraphEdgesThick: m_,
  DrawTHREEGraphEdgesThin: __,
  DrawTHREEGraphEdgesThinMutable: g_,
  DrawThickPathFromNodeIds: v_,
  AddBoxBasedImaging: el,
  AddInModularityBasedPointGroups: S_,
  DrawThinEdgesFromEdgeMap: Qc,
  DrawThickEdgesFromEdgeMap: Jc,
  AddCylinderBasedImaging: y_,
  DrawSimplifiedEdges: tl,
  ChangeTheVertexColours: E_,
  ResetVertexColors: T_,
  DrawTHREEBoxBasedVertices: M_,
  DrawTHREEBoxBasedVerticesMutable: x_
}, sc = { type: "change" }, Da = { type: "start" }, nl = { type: "end" }, Tr = new Vr(), ac = new En(), b_ = Math.cos(70 * Nf.DEG2RAD), lt = new O(), bt = 2 * Math.PI, Ze = {
  NONE: -1,
  ROTATE: 0,
  DOLLY: 1,
  PAN: 2,
...
class A_ extends a_ {
  ...
  update(e = null) {
    ...
    if (lt.setFromSpherical(this._spherical), lt.applyQuaternion(this._quatInverse), n.copy(this.target).add(lt), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
      ...
      a !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position) : (Tr.origin.copy(this.object.position), Tr.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(Tr.direction)) < b_ ? this.object.lookAt(this.target) : (ac.setFromNormalAndCoplanarPoint(this.object.up, this.target), Tr.intersectPlane(ac, this.target))));
    } else if (this.object.isOrthographicCamera) {
...
class B_ {
  ...
  async init() {
    ...
    this.camera = new zt(), this.scene = new j0(), this.renderer = new Y0({
      canvas: this.canvas,
      antialias: !0
    }), this.renderer.setSize(this.width, this.height), this.renderer.setClearColor(16711935, 0), this.scene.add(new s_(16777215));
    const n = new r_(16777215, 1);
    n.position.set(0, 10, 0), this.scene.add(n), this.controls = new A_(this.camera, this.renderer.domElement), this.camera.position.set(0, 100, 100), this.controls.autoRotate = !0, this.controls.maxPolarAngle = Math.PI * 0.5, this.controls.maxDistance = 1e4, this.controls.minDistance = 10, this.controls.update();
...
async function H_(t, e) {
  ...
  for (let l = 0; l < t; l++)
    for (let h = 0; h < t; h++)
      l != h && (s = Math.random(), e > s && (a = new Ai(l, h, {}), i.set(o, a), o += 1));
  return new Ln(n, i);
}
const vy = { GenerateErdosReyni_n_p: H_ };
function V_(t, e) {
...
function Gi(t, e, n, i, r) {
  if (t === null) return;
  const s = il(i);
  V_(e, t.item.point) <= n && r.push(t.item.nodeId);
...
async function rl(t, e) {
  ...
  for (const f of r) {
    const d = i.get(f), u = new qi({ pos: d });
    s.set(f, u);
  }
  ...
  for (const [f, d] of o) {
    ...
    a.set(l++, new Ai(u, _, { count: d }));
  }
  const h = new Ln(s, a);
  return await h.initialize(), h;
}
async function X_(t, e) {
  const i = W_().cluster(t, e);
  return rl(t, i);
}
async function q_(t, e, n) {
  const i = e.cluster(t, n);
  return rl(t, i);
}
const xy = {
  clusterByDistance: X_,
  clusterByStrategy: q_
};
function My(t, e, n, i) {
  for (let r = 0; r < e; r++) {
    let s = 0;
...
var Y_ = Math.PI / 180, j_ = 180 / Math.PI;
function Z_(t) {
  return t * Y_;
}
function K_(t) {
...
function Cg(t, e, n, i, r, s) {
  var a = new Ne(6);
  return a[0] = t, a[1] = e, a[2] = n, a[3] = i, a[4] = r, a[5] = s, a;
}
function Pg(t, e, n, i, r, s, a) {
...
function uv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], p = e[14], m = e[15], T = n * o - i * a, S = n * c - r * a, x = n * l - s * a, R = i * c - r * o, b = i * l - s * o, w = r * l - s * c, P = h * g - f * _, y = h * p - d * _, v = h * m - u * _, C = f * p - d * g, z = f * m - u * g, U = d * m - u * p, N = T * U - S * z + x * C + R * v - b * y + w * P;
  return N ? (N = 1 / N, t[0] = (o * U - c * z + l * C) * N, t[1] = (c * v - a * U - l * y) * N, t[2] = (a * z - o * v + l * P) * N, t[3] = (r * z - i * U - s * C) * N, t[4] = (n * U - r * v + s * y) * N, t[5] = (i * v - n * z - s * P) * N, t[6] = (g * w - p * b + m * R) * N, t[7] = (p * x - _ * w - m * S) * N, t[8] = (_ * b - g * x + m * T) * N, t) : null;
}
function pv(t, e, n) {
...
function Lv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], p = e[14], m = e[15], T = n * o - i * a, S = n * c - r * a, x = n * l - s * a, R = i * c - r * o, b = i * l - s * o, w = r * l - s * c, P = h * g - f * _, y = h * p - d * _, v = h * m - u * _, C = f * p - d * g, z = f * m - u * g, U = d * m - u * p;
  return t[0] = o * U - c * z + l * C, t[1] = r * z - i * U - s * C, t[2] = g * w - p * b + m * R, t[3] = d * b - f * w - u * R, t[4] = c * v - a * U - l * y, t[5] = n * U - r * v + s * y, t[6] = p * x - _ * w - m * S, t[7] = h * w - d * x + u * S, t[8] = a * z - o * v + l * P, t[9] = i * v - n * z - s * P, t[10] = _ * b - g * x + m * T, t[11] = f * x - h * b - u * T, t[12] = o * y - a * C - c * P, t[13] = n * C - i * y + r * P, t[14] = g * S - _ * R - p * T, t[15] = h * R - f * S + d * T, t;
}
function Iv(t) {
  var e = t[0], n = t[1], i = t[2], r = t[3], s = t[4], a = t[5], o = t[6], c = t[7], l = t[8], h = t[9], f = t[10], d = t[11], u = t[12], _ = t[13], g = t[14], p = t[15], m = e * a - n * s, T = e * o - i * s, S = n * o - i * a, x = l * _ - h * u, R = l * g - f * u, b = h * g - f * _, w = e * b - n * R + i * x, P = s * b - a * R + o * x, y = l * S - h * T + f * m, v = u * S - _ * T + g * m;
  return c * w - r * P + p * y - d * v;
}
function pl(t, e, n) {
...
function Fv(t, e, n, i) {
  var r = i[0], s = i[1], a = i[2], o = Math.sqrt(r * r + s * s + a * a), c, l, h, f, d, u, _, g, p, m, T, S, x, R, b, w, P, y, v, C, z, U, N, X;
  return o < pe ? null : (o = 1 / o, r *= o, s *= o, a *= o, c = Math.sin(n), l = Math.cos(n), h = 1 - l, f = e[0], d = e[1], u = e[2], _ = e[3], g = e[4], p = e[5], m = e[6], T = e[7], S = e[8], x = e[9], R = e[10], b = e[11], w = r * r * h + l, P = s * r * h + a * c, y = a * r * h - s * c, v = r * s * h - a * c, C = s * s * h + l, z = a * s * h + r * c, U = r * a * h + s * c, N = s * a * h - r * c, X = a * a * h + l, t[0] = f * w + g * P + S * y, t[1] = d * w + p * P + x * y, t[2] = u * w + m * P + R * y, t[3] = _ * w + T * P + b * y, t[4] = f * v + g * C + S * z, t[5] = d * v + p * C + x * z, t[6] = u * v + m * C + R * z, t[7] = _ * v + T * C + b * z, t[8] = f * U + g * N + S * X, t[9] = d * U + p * N + x * X, t[10] = u * U + m * N + R * X, t[11] = _ * U + T * N + b * X, e !== t && (t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]), t);
}
function Ov(t, e, n) {
...
function $v(t, e, n, i) {
  ...
  var u = 1 / n[0], _ = 1 / n[1], g = 1 / n[2], p = r * u, m = s * _, T = a * g, S = o * u, x = c * _, R = l * g, b = h * u, w = f * _, P = d * g, y = p + x + P, v = 0;
  return y > 0 ? (v = Math.sqrt(y + 1) * 2, t[3] = 0.25 * v, t[0] = (R - w) / v, t[1] = (b - T) / v, t[2] = (m - S) / v) : p > x && p > P ? (v = Math.sqrt(1 + p - x - P) * 2, t[3] = (R - w) / v, t[0] = 0.25 * v, t[1] = (m + S) / v, t[2] = (b + T) / v) : x > P ? (v = Math.sqrt(1 + x - p - P) * 2, t[3] = (b - T) / v, t[0] = (m + S) / v, t[1] = 0.25 * v, t[2] = (R + w) / v) : (v = Math.sqrt(1 + P - p - x) * 2, t[3] = (m - S) / v, t[0] = (b + T) / v, t[1] = (R + w) / v, t[2] = 0.25 * v), t;
}
function Yv(t, e, n, i) {
...
function jv(t, e, n, i, r) {
  var s = e[0], a = e[1], o = e[2], c = e[3], l = s + s, h = a + a, f = o + o, d = s * l, u = s * h, _ = s * f, g = a * h, p = a * f, m = o * f, T = c * l, S = c * h, x = c * f, R = i[0], b = i[1], w = i[2], P = r[0], y = r[1], v = r[2], C = (1 - (g + m)) * R, z = (u + x) * R, U = (_ - S) * R, N = (u - x) * b, X = (1 - (d + m)) * b, G = (p + T) * b, K = (_ + S) * w, k = (p - T) * w, te = (1 - (d + g)) * w;
  return t[0] = C, t[1] = z, t[2] = U, t[3] = 0, t[4] = N, t[5] = X, t[6] = G, t[7] = 0, t[8] = K, t[9] = k, t[10] = te, t[11] = 0, t[12] = n[0] + P - (C * P + N * y + K * v), t[13] = n[1] + y - (z * P + X * y + k * v), t[14] = n[2] + v - (U * P + G * y + te * v), t[15] = 1, t;
}
function Zv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = n + n, o = i + i, c = r + r, l = n * a, h = i * a, f = i * o, d = r * a, u = r * o, _ = r * c, g = s * a, p = s * o, m = s * c;
...
function fx(t, e) {
  var n = t[0], i = t[1], r = t[2], s = t[3], a = t[4], o = t[5], c = t[6], l = t[7], h = t[8], f = t[9], d = t[10], u = t[11], _ = t[12], g = t[13], p = t[14], m = t[15], T = e[0], S = e[1], x = e[2], R = e[3], b = e[4], w = e[5], P = e[6], y = e[7], v = e[8], C = e[9], z = e[10], U = e[11], N = e[12], X = e[13], G = e[14], K = e[15];
...
const px = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  fromRotationTranslationScale: Yv,
  fromRotationTranslationScaleOrigin: jv,
  fromScaling: Vv,
  fromTranslation: Hv,
  fromValues: Rv,
  fromXRotation: Gv,
  ...
  multiply: pl,
  multiplyScalar: cx,
  multiplyScalarAndAdd: lx,
  ortho: tx,
  orthoNO: Ml,
  orthoZO: nx,
  perspective: Jv,
  perspectiveFromFieldOfView: ex,
  perspectiveNO: xl,
  perspectiveZO: Qv,
  rotate: Fv,
  rotateX: Ov,
...
var Wx = El, Xx = Tl, qx = bl, $x = Al, Yx = wl, Pl = Sl, jx = Rl, Zx = (function() {
  var t = La();
...
var u1 = Ol, p1 = zl, m1 = Bl, _1 = Vl, g1 = kl, v1 = Ia, x1 = Ua, M1 = (function() {
  var t = Dl();
  return function(e, n, i, r, s, a) {
    var o, c;
...
var L1 = Ll, I1 = Il, Fa = Ul, U1 = Nl, N1 = Fl, F1 = $l, eh = Hl, Oa = Na, O1 = Wl, za = Ia, z1 = za, Ba = Ua, B1 = Ba, Ha = Gl, H1 = Xl;
function V1(t, e) {
...
const bM = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  fromRotationTranslationValues: j1,
  fromTranslation: Z1,
  fromValues: Y1,
  getDual: nM,
  getReal: tM,
  ...
  normalize: yM,
  rotateAroundAxis: dM,
  rotateByQuatAppend: hM,
  rotateByQuatPrepend: fM,
  rotateX: oM,
  rotateY: cM,
  rotateZ: lM,
  scale: mM,
...
var ny = dh, iy = oh, ry = ch, sy = lh, ay = hh, oy = fh, cy = uh, ly = (function() {
  var t = ah();
  return function(e, n, i, r, s, a) {
    var o, c;
...
const hy = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  vec3: Kx,
  vec4: y1
}, Symbol.toStringTag, { value: "Module" })), { vec3: Mt } = ph, fy = {
  simulationBound: 100,
  cohesionValue: 1,
  repulsionValue: 1,
  centerPull: 0.1,
...
function Sy(t, e = {}) {
  const n = { ...fy, ...e }, i = t.get_node_ids_order(), r = i.length, s = t.get_adjacency(), a = /* @__PURE__ */ new Map();
...
async function Ey(t, e = {}) {
  const n = { ...dy, ...e }, i = t.get_node_ids_order(), r = i.length, s = /* @__PURE__ */ new Map();
  i.forEach((R, b) => s.set(R, b));
  const a = await uy(t, i);
  a.length;
  let o = 1 / 0, c = -1 / 0;
  for (const R of a)
  ...
  function T(R) {
    ...
    g += n.scheduleSpeed;
    for (let P = 0; P < b && a.length !== 0; P++) {
      const y = a[Math.floor(Math.random() * a.length)], { i: v, j: C, d: z, w: U } = y;
      ln.set(p.pi, _[v * 3], _[v * 3 + 1], _[v * 3 + 2]), ln.set(p.pj, _[C * 3], _[C * 3 + 1], _[C * 3 + 2]), ln.subtract(p.diff, p.pj, p.pi), u === 2 && (p.diff[2] = 0);
      const N = Math.max(ln.length(p.diff), m);
      let X = w * U;
      X > 1 && (X = 1);
      const G = X * (N - z) / (2 * N);
      ln.scale(p.diff, p.diff, G), _[v * 3] -= p.diff[0], _[v * 3 + 1] -= p.diff[1], u === 3 && (_[v * 3 + 2] -= p.diff[2]), _[C * 3] += p.diff[0], _[C * 3 + 1] += p.diff[1], u === 3 && (_[C * 3 + 2] += p.diff[2]);
    }
    if (n.centerPull > 0)
      for (let P = 0; P < r; P++)
        _[P * 3] -= n.centerPull * _[P * 3], _[P * 3 + 1] -= n.centerPull * _[P * 3 + 1], u === 3 && (_[P * 3 + 2] -= n.centerPull * _[P * 3 + 2]);
...
export {
  ...
  _y as ThreeWrapper,
  At as Utilities,
  Sy as createKamadaKawai3D,
  Ey as createStressSGD3D,
  ph as glMatrix,
  My as matrixVectorMultiply,
  yy as normalizeVector
};
