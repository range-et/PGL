...
function cc(t, e, n) {
  ...
  for (let o = 0; o <= n; o++) {
    const c = o / n, l = c * i.x + (1 - c) * r.x, h = c * i.y + (1 - c) * r.y, f = c * i.z + (1 - c) * r.z, d = new Lt(l, h, f);
    s.push(d);
  }
  return new va(s);
}
...
async function Dh(t, e, n = 100, i = 1, r = 1) {
  ...
  for (let y = 0; y < e; y++) {
    let x, C, b, w, P, E, v, R, z, U, F, X, G, K;
    for (const k of s.keys()) {
      ...
      z = r * 1 / (At.calculateAverage(E) * At.calculateAverage(E)), U = r * 1 / (At.calculateAverage(P) * At.calculateAverage(P)), v = i * (F - x), R = i * (X - C), G = i * (0 - x), K = i * (0 - C);
      const q = z + G + v + x, Q = U + K + R + C;
      a.set(k, q), o.set(k, Q);
    }
  }
  let h = /* @__PURE__ */ new Map();
  for (const y of a.keys())
    h.set(y, new Lt(a.get(y), 0, o.get(y)));
  const f = [], d = [], u = [];
  let _;
  for (const y of h.keys())
    _ = h.get(y), f.push(_.x), d.push(_.y), u.push(_.z);
  const g = At.calculateAverage(f), m = At.calculateAverage(d), p = At.calculateAverage(u), T = new Lt(
    -g,
    -m,
    -p
  );
...
async function Fh(t, e, n, i) {
  ...
  for (const _ of r.keys()) {
    const g = s.get(_) * n, m = o.get(s.get(_)), p = 2 * Math.PI * (m.indexOf(_) / m.length), T = Math.sin(p) * g, y = Math.cos(p) * g, x = new Lt(T + l, -g + h, y + f);
    c.set(_, x);
  }
...
const Ge = {
  ...
  convert: function(t, e, n) {
    return this.enabled === !1 || e === n || !e || !n || (this.spaces[e].transfer === je && (t.r = fn(t.r), t.g = fn(t.g), t.b = fn(t.b)), this.spaces[e].primaries !== this.spaces[n].primaries && (t.applyMatrix3(this.spaces[e].toXYZ), t.applyMatrix3(this.spaces[n].fromXYZ)), this.spaces[n].transfer === je && (t.r = xi(t.r), t.g = xi(t.g), t.b = xi(t.b))), t;
  },
...
let Vf = 0;
class xt extends $n {
  constructor(e = xt.DEFAULT_IMAGE, n = xt.DEFAULT_MAPPING, i = kn, r = kn, s = Jt, a = Gn, o = qt, c = dn, l = xt.DEFAULT_ANISOTROPY, h = wn) {
...
class Yn {
  ...
  intersectsTriangle(e) {
    if (this.isEmpty())
      return !1;
    this.getCenter(Ii), Qi.subVectors(this.max, Ii), ei.subVectors(e.a, Ii), ti.subVectors(e.b, Ii), ni.subVectors(e.c, Ii), _n.subVectors(ti, ei), gn.subVectors(ni, ti), In.subVectors(ei, ni);
    let n = [
      0,
      -_n.z,
      _n.y,
    ...
    return !Qr(n, ei, ti, ni, Qi) || (n = [1, 0, 0, 0, 1, 0, 0, 0, 1], !Qr(n, ei, ti, ni, Qi)) ? !1 : (er.crossVectors(_n, gn), n = [er.x, er.y, er.z], Qr(n, ei, ti, ni, Qi));
  }
  clampPoint(e, n) {
...
const rn = [
  ...
  /* @__PURE__ */ new O(),
  /* @__PURE__ */ new O()
], kt = /* @__PURE__ */ new O(), Ji = /* @__PURE__ */ new Yn(), ei = /* @__PURE__ */ new O(), ti = /* @__PURE__ */ new O(), ni = /* @__PURE__ */ new O(), _n = /* @__PURE__ */ new O(), gn = /* @__PURE__ */ new O(), In = /* @__PURE__ */ new O(), Ii = /* @__PURE__ */ new O(), Qi = /* @__PURE__ */ new O(), er = /* @__PURE__ */ new O(), Un = /* @__PURE__ */ new O();
...
const sn = /* @__PURE__ */ new O(), ts = /* @__PURE__ */ new O(), tr = /* @__PURE__ */ new O(), vn = /* @__PURE__ */ new O(), ns = /* @__PURE__ */ new O(), nr = /* @__PURE__ */ new O(), is = /* @__PURE__ */ new O();
class Vr {
  ...
  distanceSqToSegment(e, n, i, r) {
    ts.copy(e).add(n).multiplyScalar(0.5), tr.copy(n).sub(e).normalize(), vn.copy(this.origin).sub(ts);
    const s = e.distanceTo(n) * 0.5, a = -this.direction.dot(tr), o = vn.dot(this.direction), c = -vn.dot(tr), l = vn.lengthSq(), h = Math.abs(1 - a * a);
    let f, d, u, _;
    if (h > 0)
    ...
    return i && i.copy(this.origin).addScaledVector(this.direction, f), r && r.copy(ts).addScaledVector(tr, d), u;
  }
  intersectSphere(e, n) {
  ...
  intersectTriangle(e, n, i, r, s) {
    ...
    if (c < 0)
      return null;
    const l = o * this.direction.dot(ns.cross(vn));
    if (l < 0 || c + l > a)
      return null;
    const h = -o * vn.dot(is);
...
class Ke {
  ...
  lookAt(e, n, i) {
    ...
    return Pt.subVectors(e, n), Pt.lengthSq() === 0 && (Pt.z = 1), Pt.normalize(), xn.crossVectors(i, Pt), xn.lengthSq() === 0 && (Math.abs(i.z) === 1 ? Pt.x += 1e-4 : Pt.z += 1e-4, Pt.normalize(), xn.crossVectors(i, Pt)), xn.normalize(), ir.crossVectors(Pt, xn), r[0] = xn.x, r[4] = ir.x, r[8] = Pt.x, r[1] = xn.y, r[5] = ir.y, r[9] = Pt.y, r[2] = xn.z, r[6] = ir.z, r[10] = Pt.z, this;
  }
  multiply(e) {
    return this.multiplyMatrices(this, e);
  }
  ...
  multiplyMatrices(e, n) {
    const i = e.elements, r = n.elements, s = this.elements, a = i[0], o = i[4], c = i[8], l = i[12], h = i[1], f = i[5], d = i[9], u = i[13], _ = i[2], g = i[6], m = i[10], p = i[14], T = i[3], y = i[7], x = i[11], C = i[15], b = r[0], w = r[4], P = r[8], E = r[12], v = r[1], R = r[5], z = r[9], U = r[13], F = r[2], X = r[6], G = r[10], K = r[14], k = r[3], te = r[7], le = r[11], ve = r[15];
    return s[0] = a * b + o * v + c * F + l * k, s[4] = a * w + o * R + c * X + l * te, s[8] = a * P + o * z + c * G + l * le, s[12] = a * E + o * U + c * K + l * ve, s[1] = h * b + f * v + d * F + u * k, s[5] = h * w + f * R + d * X + u * te, s[9] = h * P + f * z + d * G + u * le, s[13] = h * E + f * U + d * K + u * ve, s[2] = _ * b + g * v + m * F + p * k, s[6] = _ * w + g * R + m * X + p * te, s[10] = _ * P + g * z + m * G + p * le, s[14] = _ * E + g * U + m * K + p * ve, s[3] = T * b + y * v + x * F + C * k, s[7] = T * w + y * R + x * X + C * te, s[11] = T * P + y * z + x * G + C * le, s[15] = T * E + y * U + x * K + C * ve, this;
  }
  multiplyScalar(e) {
    const n = this.elements;
...
const ii = /* @__PURE__ */ new O(), Gt = /* @__PURE__ */ new Ke(), Xf = /* @__PURE__ */ new O(0, 0, 0), qf = /* @__PURE__ */ new O(1, 1, 1), xn = /* @__PURE__ */ new O(), ir = /* @__PURE__ */ new O(), Pt = /* @__PURE__ */ new O(), lo = /* @__PURE__ */ new Ke(), ho = /* @__PURE__ */ new Dn();
class un {
...
class ut extends $n {
  constructor() {
    ...
    const e = new O(), n = new un(), i = new Dn(), r = new O(1, 1, 1);
    function s() {
      i.setFromEuler(n, !1);
    }
    function a() {
...
class Oe {
  ...
  lerpHSL(e, n) {
    this.getHSL(Mn), e.getHSL(sr);
    const i = jr(Mn.h, sr.h, n), r = jr(Mn.s, sr.s, n), s = jr(Mn.l, sr.l, n);
      ...
      if (Array.isArray(a))
        for (let _ = 0, g = d.length; _ < g; _++) {
          ...
          for (let x = T, C = y; x < C; x += 3) {
            ...
            r = ur(this, p, e, i, l, h, f, b, w, P), r && (r.faceIndex = Math.floor(x / 3), r.face.materialIndex = m.materialIndex, n.push(r));
          }
        }
      else {
        ...
        for (let m = _, p = g; m < p; m += 3) {
          ...
          r = ur(this, a, e, i, l, h, f, T, y, x), r && (r.faceIndex = Math.floor(m / 3), n.push(r));
        }
      }
    else if (c !== void 0)
      if (Array.isArray(a))
...
function ur(t, e, n, i, r, s, a, o, c, l) {
  ...
  if (h) {
    ...
    Xt.getNormal(cr, lr, hr, d.normal), h.face = d, h.barycoord = f;
  }
  return h;
}
class Zn extends pt {
  constructor(e = 1, n = 1, i = 1, r = 1, s = 1, a = 1) {
    ...
    function _(g, m, p, T, y, x, C, b, w, P, E) {
      const v = x / w, R = C / P, z = x / 2, U = C / 2, F = b / 2, X = w + 1, G = P + 1;
      let K = 0, k = 0;
      const te = new O();
...
class Uc extends ut {
  constructor() {
    super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Ke(), this.projectionMatrix = new Ke(), this.projectionMatrixInverse = new Ke(), this.coordinateSystem = hn;
  }
  copy(e, n) {
...
const yn = /* @__PURE__ */ new O(), yo = /* @__PURE__ */ new we(), So = /* @__PURE__ */ new we();
class zt extends Uc {
...
const mr = { r: 0, b: 0, g: 0 }, On = /* @__PURE__ */ new un(), kp = /* @__PURE__ */ new Ke();
function Gp(t, e, n, i, r, s, a) {
  ...
  function m(T, y) {
    ...
    }), r.update(h)), On.copy(y.backgroundRotation), On.x *= -1, On.y *= -1, On.z *= -1, x.isCubeTexture && x.isRenderTargetTexture === !1 && (On.y *= -1, On.z *= -1), h.material.uniforms.envMap.value = x, h.material.uniforms.flipEnvMap.value = x.isCubeTexture && x.isRenderTargetTexture === !1 ? -1 : 1, h.material.uniforms.backgroundBlurriness.value = y.backgroundBlurriness, h.material.uniforms.backgroundIntensity.value = y.backgroundIntensity, h.material.uniforms.backgroundRotation.value.setFromMatrix4(kp.makeRotationFromEuler(On)), h.material.toneMapped = Ge.getTransfer(x.colorSpace) !== je, (f !== x || d !== x.version || u !== t.toneMapping) && (h.material.needsUpdate = !0, f = x, d = x.version, u = t.toneMapping), h.layers.enableAll(), T.unshift(h, h.geometry, h.material, 0, 0, null)) : x && x.isTexture && (l === void 0 && (l = new wt(
      new kr(2, 2),
      new Yt({
  ...
  function p(T, y) {
    T.getRGB(mr, Ic(t)), i.buffers.color.setClear(mr.r, mr.g, mr.b, y, a);
  }
  return {
...
function Wp(t, e) {
  ...
  let s = r, a = !1;
  function o(v, R, z, U, F) {
    let X = !1;
    const G = f(U, z, R);
    s !== G && (s = G, l(s.object)), X = u(v, U, z, F), X && _(v, U, z, F), F !== null && e.update(F, t.ELEMENT_ARRAY_BUFFER), (X || a) && (a = !1, x(v, R, z, U), F !== null && t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, e.get(F).buffer));
  }
  function c() {
  ...
  function _(v, R, z, U) {
    ...
    s.attributes = F, s.attributesNum = G, s.index = U;
  }
  function g() {
  ...
  function p(v, R) {
    const z = s.newAttributes, U = s.enabledAttributes, F = s.attributeDivisors;
    z[v] = 1, U[v] === 0 && (t.enableVertexAttribArray(v), U[v] = 1), F[v] !== R && (t.vertexAttribDivisor(v, R), F[v] = R);
  }
  function T() {
  ...
  function y(v, R, z, U, F, X, G) {
    G === !0 ? t.vertexAttribIPointer(v, R, z, F, X) : t.vertexAttribPointer(v, R, z, U, F, X);
  }
  function x(v, R, z, U) {
    g();
    const F = U.attributes, X = z.getAttributes(), G = R.defaultAttributeValues;
    for (const K in X) {
      const k = X[K];
      if (k.location >= 0) {
        let te = F[K];
...
function qp(t, e, n, i) {
  ...
  function o(w) {
    const P = w === $i && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
...
class Ao {
  ...
  _sceneToCubeUV(e, n, i, r) {
    ...
    for (let p = 0; p < 6; p++) {
      ...
      _r(r, T * y, p > 2 ? y : 0, y, y), h.setRenderTarget(r), g && h.render(_, o), h.render(e, o);
    }
  ...
  _halfBlur(e, n, i, r, s, a, o) {
    ...
    const h = 3, f = new wt(this._lodPlanes[r], l), d = l.uniforms, u = this._sizeLods[i] - 1, _ = isFinite(s) ? Math.PI / (2 * u) : 2 * Math.PI / (2 * Vn - 1), g = s / _, m = isFinite(s) ? 1 + Math.floor(h * g) : Vn;
    ...
    const x = this._sizeLods[r], C = 3 * x * (r > y - pi ? r - y + pi : 0), b = 4 * (this._cubeSize - x);
    _r(n, C, b, 3 * x, 2 * x), c.setRenderTarget(n), c.render(f, _s);
  }
}
function jp(t) {
  const e = [], n = [], i = [];
  ...
  for (let a = 0; a < s; a++) {
    ...
    const C = new pt();
    C.setAttribute("position", new Bt(T, g)), C.setAttribute("uv", new Bt(y, m)), C.setAttribute("faceIndex", new Bt(x, p)), e.push(C), r > pi && r--;
  }
...
function nm(t, e, n) {
  ...
  function s(a, o, c) {
    ...
    if (d === void 0 || d.count !== f) {
      ...
      const b = new Float32Array(x * C * 4 * f), w = new wc(b, x, C, f);
      w.type = Qt, w.needsUpdate = !0;
      const P = y * 4;
      for (let v = 0; v < f; v++) {
        const R = m[v], z = p[v], U = T[v], F = x * C * 4 * v;
        for (let X = 0; X < R.count; X++) {
          const G = X * P;
          u === !0 && (r.fromBufferAttribute(R, X), b[F + G + 0] = r.x, b[F + G + 1] = r.y, b[F + G + 2] = r.z, b[F + G + 3] = 0), _ === !0 && (r.fromBufferAttribute(z, X), b[F + G + 4] = r.x, b[F + G + 5] = r.y, b[F + G + 6] = r.z, b[F + G + 7] = 0), g === !0 && (r.fromBufferAttribute(U, X), b[F + G + 8] = r.x, b[F + G + 9] = r.y, b[F + G + 10] = r.z, b[F + G + 11] = U.itemSize === 4 ? r.w : 1);
        }
      }
      d = {
        count: f,
...
function l0(t) {
  ...
  return t.shadowMapType === dc ? e = "SHADOWMAP_TYPE_PCF" : t.shadowMapType === qh ? e = "SHADOWMAP_TYPE_PCF_SOFT" : t.shadowMapType === ln && (e = "SHADOWMAP_TYPE_VSM"), e;
}
function h0(t) {
...
function p0(t, e, n, i) {
  ...
  const c = l0(n), l = h0(n), h = f0(n), f = d0(n), d = u0(n), u = t0(n), _ = n0(s), g = r.createProgram();
...
`) + `
` + p);
  const y = T + m + a, x = T + p + o, C = Oo(r, r.VERTEX_SHADER, y), b = Oo(r, r.FRAGMENT_SHADER, x);
  ...
  function w(R) {
    if (t.debug.checkShaderErrors) {
      const z = r.getProgramInfoLog(g).trim(), U = r.getShaderInfoLog(C).trim(), F = r.getShaderInfoLog(b).trim();
      let X = !0, G = !0;
      if (r.getProgramParameter(g, r.LINK_STATUS) === !1)
        if (X = !1, typeof t.debug.onShaderError == "function")
          t.debug.onShaderError(r, g, C, b);
        else {
          const K = Bo(r, C, "vertex"), k = Bo(r, b, "fragment");
          console.error(
...
` + k
      ...
      else z !== "" ? console.warn("THREE.WebGLProgram: Program Info Log:", z) : (U === "" || F === "") && (G = !1);
      G && (R.diagnostics = {
        runnable: X,
        programLog: z,
        vertexShader: {
    ...
    r.deleteShader(C), r.deleteShader(b), P = new Pr(r, g), E = i0(r, g);
  }
  let P;
  ...
  return this.isReady = function() {
    return v === !1 && (v = r.getProgramParameter(g, Ym)), v;
  }, this.destroy = function() {
    i.releaseStatesOfProgram(this), r.deleteProgram(g), this.program = void 0;
  }, this.type = n.shaderType, this.name = n.shaderName, this.id = jm++, this.cacheKey = e, this.usedTimes = 1, this.program = g, this.vertexShader = C, this.fragmentShader = b, this;
}
let m0 = 0;
class _0 {
  constructor() {
...
function v0(t, e, n, i, r, s, a) {
  const o = new Rc(), c = new _0(), l = /* @__PURE__ */ new Set(), h = [], f = r.logarithmicDepthBuffer, d = r.vertexTextures;
  let u = r.precision;
  const _ = {
  ...
  function m(E, v, R, z, U) {
    const F = z.fog, X = U.geometry, G = E.isMeshStandardMaterial ? z.environment : null, K = (E.isMeshStandardMaterial ? n : e).get(E.envMap || G), k = K && K.mapping === Br ? K.image.height : null, te = _[E.type];
    ...
    const mt = {
      ...
      emissiveMap: et,
      normalMapObjectSpace: Be && E.normalMapType === bf,
      normalMapTangentSpace: Be && E.normalMapType === Tf,
      metalnessMap: ye,
      roughnessMap: A,
      anisotropy: M,
      anisotropyMap: se,
      ...
      thicknessMap: re,
      gradientMap: W,
      opaque: E.transparent === !1 && E.blending === gi && E.alphaToCoverage === !1,
      alphaMap: j,
      alphaTest: ce,
      alphaHash: ae,
      combine: E.combine,
      ...
      lightMapUv: Ut && g(E.lightMap.channel),
      ...
      specularColorMapUv: Ie && g(E.specularColorMap.channel),
  ...
  function C(E, v) {
    ...
    return R === void 0 && (R = new p0(t, v, E, s), h.push(R)), R;
  }
  function b(E) {
    if (--E.usedTimes === 0) {
      const v = h.indexOf(E);
...
function Xo() {
  ...
  function l(f, d) {
    n.length > 1 && n.sort(f || M0), i.length > 1 && i.sort(d || Wo), r.length > 1 && r.sort(d || Wo);
  }
  function h() {
...
function A0(t) {
  ...
  function o(l) {
    ...
    for (let E = 0, v = l.length; E < v; E++) {
      const R = l[E], z = R.color, U = R.intensity, F = R.distance, X = R.shadow && R.shadow.map ? R.shadow.map.texture : null;
      if (R.isAmbientLight)
        h += z.r * U, f += z.g * U, d += z.b * U;
      else if (R.isLightProbe) {
        for (let G = 0; G < 9; G++)
          i.probe[G].addScaledVector(R.sh.coefficients[G], U);
        w++;
        ...
        const G = e.get(R);
        G.position.setFromMatrixPosition(R.matrixWorld), G.color.copy(z).multiplyScalar(U), G.distance = F, G.coneCos = Math.cos(R.angle), G.penumbraCos = Math.cos(R.angle * (1 - R.penumbra)), G.decay = R.decay, i.spot[g] = G;
        const K = R.shadow;
        ...
        const G = e.get(R);
        G.color.copy(z).multiplyScalar(U), G.halfWidth.set(R.width * 0.5, 0, 0), G.halfHeight.set(0, R.height * 0.5, 0), i.rectArea[m] = G, m++;
        ...
        const G = e.get(R);
        G.skyColor.copy(R.color).multiplyScalar(U), G.groundColor.copy(R.groundColor).multiplyScalar(U), i.hemi[p] = G, p++;
      }
    }
...
function L0(t, e, n) {
  let i = new wa();
  const r = new we(), s = new we(), a = new st(), o = new R0({ depthPacking: Ef }), c = new C0(), l = {}, h = n.maxTextureSize, f = { [Pn]: Rt, [Rt]: Pn, [Kt]: Kt }, d = new Yt({
    defines: {
      VSM_SAMPLES: 8
    },
    uniforms: {
  ...
  this.render = function(b, w, P) {
    ...
    const U = p !== ln && this.type === ln, F = p === ln && this.type !== ln;
    for (let X = 0, G = b.length; X < G; X++) {
      ...
      if (r.multiply(te), s.copy(k.mapSize), (r.x > h || r.y > h) && (r.x > h && (s.x = Math.floor(h / te.x), r.x = s.x * te.x, k.mapSize.x = s.x), r.y > h && (s.y = Math.floor(h / te.y), r.y = s.y * te.y, k.mapSize.y = s.y)), k.map === null || U === !0 || F === !0) {
        const ve = this.type !== ln ? { minFilter: It, magFilter: It } : {};
      ...
      k.isPointLightShadow !== !0 && this.type === ln && T(k, P), k.needsUpdate = !1;
    }
    p = this.type, m.needsUpdate = !1, t.setRenderTarget(E, v, R);
  };
  function T(b, w) {
    const P = e.update(g);
    d.defines.VSM_SAMPLES !== b.blurSamples && (d.defines.VSM_SAMPLES = b.blurSamples, u.defines.VSM_SAMPLES = b.blurSamples, d.needsUpdate = !0, u.needsUpdate = !0), b.mapPass === null && (b.mapPass = new Xn(r.x, r.y)), d.uniforms.shadow_pass.value = b.map.texture, d.uniforms.resolution.value = b.mapSize, d.uniforms.radius.value = b.radius, t.setRenderTarget(b.mapPass), t.clear(), t.renderBufferDirect(w, null, P, d, g, null), u.uniforms.shadow_pass.value = b.mapPass.texture, u.uniforms.resolution.value = b.mapSize, u.uniforms.radius.value = b.radius, t.setRenderTarget(b.map), t.clear(), t.renderBufferDirect(w, null, P, u, g, null);
  }
  function y(b, w, P, E) {
    let v = null;
    ...
    if (R !== void 0)
      ...
      F === void 0 && (F = {}, l[z] = F);
      let X = F[U];
      X === void 0 && (X = v.clone(), F[U] = X, w.addEventListener("dispose", C)), v = X;
    }
  ...
  function x(b, w, P, E, v) {
    ...
    if (b.layers.test(w.layers) && (b.isMesh || b.isLine || b.isPoints) && (b.castShadow || b.receiveShadow && v === ln) && (!b.frustumCulled || i.intersectsObject(b))) {
      b.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse, b.matrixWorld);
      const U = e.update(b), F = b.material;
      if (Array.isArray(F)) {
        const X = U.groups;
...
function U0(t, e) {
  ...
  let h = {}, f = {}, d = /* @__PURE__ */ new WeakMap(), u = [], _ = null, g = !1, m = null, p = null, T = null, y = null, x = null, C = null, b = null, w = new Oe(0, 0, 0), P = 0, E = !1, v = null, R = null, z = null, U = null, F = null;
  ...
  function N(D, re, W, j, ce, ae, Ce, rt, mt, Ye) {
    ...
    if (g === !1 && (ie(t.BLEND), g = !0), D !== $h) {
      if (D !== m || Ye !== E) {
        if ((p !== Hn || x !== Hn) && (t.blendEquation(t.FUNC_ADD), p = Hn, x = Hn), Ye)
          switch (D) {
            case gi:
  ...
  function Ut(D, re) {
    ...
    let W = D.side === Rt;
    re && (W = !W), ze(W), D.blending === gi && D.transparent === !1 ? N(Rn) : N(D.blending, D.blendEquation, D.blendSrc, D.blendDst, D.blendEquationAlpha, D.blendSrcAlpha, D.blendDstAlpha, D.blendColor, D.blendAlpha, D.premultipliedAlpha), a.setFunc(D.depthFunc), a.setTest(D.depthTest), a.setMask(D.depthWrite), s.setMask(D.colorWrite);
  ...
  function Be(D) {
    D !== Wh ? (ie(t.CULL_FACE), D !== R && (D === ja ? t.cullFace(t.BACK) : D === Xh ? t.cullFace(t.FRONT) : t.cullFace(t.FRONT_AND_BACK))) : Se(t.CULL_FACE), R = D;
  }
  function Ee(D) {
    D !== z && (G && t.lineWidth(D), z = D);
  }
  function et(D, re, W) {
    D ? (ie(t.POLYGON_OFFSET_FILL), (U !== re || F !== W) && (t.polygonOffset(re, W), U = re, F = W)) : Se(t.POLYGON_OFFSET_FILL);
  }
  function ye(D) {
...
function F0(t, e, n, i, r, s, a) {
  ...
  function q(A, M, B) {
    ...
    if ($.version !== xe.__version || Z === !0) {
      ...
      Le(Y, M);
      let ue;
      const He = M.mipmaps, Ie = M.isVideoTexture !== !0, Je = xe.__version === void 0 || Z === !0, D = $.dataReady, re = C(M, J);
      if (M.isDepthTexture)
  ...
  function Q(A, M, B) {
    ...
    if (Z.version !== $.__version || Y === !0) {
      ...
      const Te = de[0], be = s.convert(M.format, M.colorSpace), ue = s.convert(M.type), He = y(M.internalFormat, be, ue, M.colorSpace), Ie = M.isVideoTexture !== !0, Je = $.__version === void 0 || Y === !0, D = Z.dataReady;
      let re = C(M, Te);
  ...
  function et(A, M) {
    ...
    return A.isCompressedTexture === !0 || A.isVideoTexture === !0 || B !== Ai && B !== wn && (Ge.getTransfer(B) === je ? (Y !== qt || Z !== dn) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", B)), M;
  }
  function ye(A) {
...
class G0 extends $n {
  constructor(e, n) {
    ...
    function F() {
      r.removeEventListener("select", U), r.removeEventListener("selectstart", U), r.removeEventListener("selectend", U), r.removeEventListener("squeeze", U), r.removeEventListener("squeezestart", U), r.removeEventListener("squeezeend", U), r.removeEventListener("end", F), r.removeEventListener("inputsourceschange", X);
    ...
    this.setFramebufferScaleFactor = function(q) {
      ...
      if (r = q, r !== null) {
        if (p = e.getRenderTarget(), r.addEventListener("select", U), r.addEventListener("selectstart", U), r.addEventListener("selectend", U), r.addEventListener("squeeze", U), r.addEventListener("squeezestart", U), r.addEventListener("squeezeend", U), r.addEventListener("end", F), r.addEventListener("inputsourceschange", X), m.xrCompatible !== !0 && await n.makeXRCompatible(), b = e.getPixelRatio(), e.getSize(C), r.renderState.layers === void 0) {
          ...
          u = new XRWebGLLayer(r, n, Q), r.updateRenderState({ baseLayer: u }), e.setPixelRatio(1), e.setSize(u.framebufferWidth, u.framebufferHeight, !1), T = new Xn(
            u.framebufferWidth,
            u.framebufferHeight,
            {
              format: qt,
          ...
          f = new XRWebGLBinding(r, n), d = f.createProjectionLayer(Se), r.updateRenderState({ layers: [d] }), e.setPixelRatio(1), e.setSize(d.textureWidth, d.textureHeight, !1), T = new Xn(
            d.textureWidth,
            d.textureHeight,
            {
              format: qt,
    ...
    function k(q, Q, he) {
      ...
      const ie = G.distanceTo(K), Se = Q.projectionMatrix.elements, Re = he.projectionMatrix.elements, Fe = Se[14] / (Se[10] - 1), it = Se[14] / (Se[10] + 1), Ve = (Se[9] + 1) / Se[5], at = (Se[9] - 1) / Se[5], N = (Se[8] - 1) / Se[0], Ut = (Re[8] + 1) / Re[0], ze = Fe * N, Be = Fe * Ut, Ee = ie / (-N + Ut), et = Ee * -N;
...
const zn = /* @__PURE__ */ new un(), W0 = /* @__PURE__ */ new Ke();
function X0(t, e) {
  function n(m, p) {
  ...
  function s(m, p) {
    ...
    y && (m.envMap.value = y, zn.copy(x), zn.x *= -1, zn.y *= -1, zn.z *= -1, y.isCubeTexture && y.isRenderTargetTexture === !1 && (zn.y *= -1, zn.z *= -1), m.envMapRotation.value.setFromMatrix4(W0.makeRotationFromEuler(zn)), m.flipEnvMap.value = y.isCubeTexture && y.isRenderTargetTexture === !1 ? -1 : 1, m.reflectivity.value = p.reflectivity, m.ior.value = p.ior, m.refractionRatio.value = p.refractionRatio), p.lightMap && (m.lightMap.value = p.lightMap, m.lightMapIntensity.value = p.lightMapIntensity, n(p.lightMap, m.lightMapTransform)), p.aoMap && (m.aoMap.value = p.aoMap, m.aoMapIntensity.value = p.aoMapIntensity, n(p.aoMap, m.aoMapTransform));
  }
  function a(m, p) {
  ...
  function d(T) {
    ...
    for (let b = 0, w = x.length; b < w; b++) {
      ...
      for (let E = 0, v = P.length; E < v; E++) {
        const R = P[E];
        if (u(R, b, E, C) === !0) {
          const z = R.__offset, U = Array.isArray(R.value) ? R.value : [R.value];
          let F = 0;
  ...
  function _(T) {
    ...
    for (let w = 0, P = y.length; w < P; w++) {
      ...
      for (let v = 0, R = E.length; v < R; v++) {
        const z = E[v], U = Array.isArray(z.value) ? z.value : [z.value];
        for (let F = 0, X = U.length; F < X; F++) {
          const G = U[F], K = g(G), k = x % C, te = k % K.boundary, le = k + te;
...
class $0 {
  constructor(e = {}) {
    ...
    try {
      ...
      if ("setAttribute" in n && n.setAttribute("data-engine", `three.js r${xa}`), n.addEventListener("webglcontextlost", j, !1), n.addEventListener("webglcontextrestored", ce, !1), n.addEventListener("webglcontextcreationerror", ae, !1), N === null) {
        const L = "webgl2";
        if (N = Ut(L, S), N === null)
    ...
    function re() {
      ze = new Jp(N), ze.init(), Ie = new O0(N, ze), Be = new qp(N, ze, e, Ie), Ee = new U0(N, ze), Be.reverseDepthBuffer && d && Ee.buffers.depth.setReversed(!0), et = new tm(N), ye = new x0(), A = new F0(N, ze, Ee, ye, Be, Ie, et), M = new Yp(x), B = new Kp(x), Y = new cd(N), Je = new Wp(N, Y), Z = new Qp(N, Y, et, Je), $ = new im(N, Z, Y, et), be = new nm(N, Be, A), J = new $p(ye), xe = new v0(x, M, B, ze, Be, Je, J), se = new X0(x, ye), fe = new y0(), ke = new w0(ze), Te = new Gp(x, M, B, Ee, $, u, c), de = new L0(x, $, Be), D = new q0(N, et, Be, Ee), ue = new Xp(N, ze, et), He = new em(N, ze, et), et.programs = xe.programs, x.capabilities = Be, x.extensions = ze, x.properties = ye, x.renderLists = fe, x.shadowMap = de, x.state = Ee, x.info = et;
    }
    re();
    const W = new G0(x, N);
    this.xr = W, this.getContext = function() {
      ...
      if (S) {
        ...
        if (I) {
          const ee = P.texture.type, oe = ee === dn || ee === Wn || ee === Gi || ee === Ei || ee === ya || ee === Sa, me = Te.getClearColor(), _e = Te.getClearAlpha(), Ae = me.r, Pe = me.g, ge = me.b;
    ...
    function ce() {
      ...
      const S = et.autoReset, L = de.enabled, H = de.autoUpdate, V = de.needsUpdate, I = de.type;
      re(), et.autoReset = S, de.enabled = L, de.autoUpdate = H, de.needsUpdate = V, de.type = I;
    }
    function ae(S) {
    ...
    this.renderBufferDirect = function(S, L, H, V, I, ee) {
      L === null && (L = it);
      const oe = I.isMesh && I.matrixWorld.determinant() < 0, me = mh(S, L, H, V, I);
      Ee.setMaterial(V, oe);
      let _e = H.index, Ae = 1;
      if (V.wireframe === !0) {
      ...
      if (_e !== null && (Et = Y.get(_e), qe = He, qe.setIndex(Et)), I.isMesh)
        ...
        let Me = V.linewidth;
        Me === void 0 && (Me = 1), Ee.setLineWidth(Me * at()), I.isLineSegments ? qe.setMode(N.LINES) : I.isLineLoop ? qe.setMode(N.LINE_LOOP) : qe.setMode(N.LINE_STRIP);
      } else I.isPoints ? qe.setMode(N.POINTS) : I.isSprite && qe.setMode(N.TRIANGLES);
      if (I.isBatchedMesh)
        if (I._multiDrawInstances !== null)
          ...
          for (let Ct = 0; Ct < $e; Ct++)
            Kn.setValue(N, "_gl_DrawID", Ct), qe.render(Me[Ct] / Vt, nn[Ct]);
        }
    ...
    function Ye(S, L, H) {
      S.transparent === !0 && S.side === Kt && S.forceSinglePass === !1 ? (S.side = Rt, S.needsUpdate = !0, Zi(S, L, H), S.side = Pn, S.needsUpdate = !0, Zi(S, L, H), S.side = Kt) : Zi(S, L, H);
    }
    this.compile = function(S, L, H = null) {
      H === null && (H = S), p = ke.get(H), p.init(L), y.push(p), H.traverseVisible(function(I) {
        I.isLight && I.layers.test(L.layers) && (p.pushLight(I), I.castShadow && p.pushShadow(I));
      }), S !== H && S.traverseVisible(function(I) {
        I.isLight && I.layers.test(L.layers) && (p.pushLight(I), I.castShadow && p.pushShadow(I));
      }), p.setupLights();
    ...
    const Ln = new Fc();
    Ln.setAnimationLoop(tn), typeof self < "u" && Ln.setContext(self), this.setAnimationLoop = function(S) {
      Ht = S, W.setAnimationLoop(S), S === null ? Ln.stop() : Ln.start();
    }, W.addEventListener("sessionstart", Va), W.addEventListener("sessionend", ka), this.render = function(S, L) {
      ...
      $r(S, L, 0, x.sortObjects), m.finish(), x.sortObjects === !0 && m.sort(te, le), Ve = W.enabled === !1 || W.isPresenting === !1 || W.hasDepthSensing() === !1, Ve && Te.addToRenderList(m, S), this.info.render.frame++, Q === !0 && J.beginShadows();
      ...
      if (p.setupLights(), L.isArrayCamera) {
        ...
        for (let oe = 0, me = ee.length; oe < me; oe++) {
          const _e = ee[oe];
          Ga(m, S, _e, _e.viewport);
        }
      } else
        I.length > 0 && Wa(V, I, S, L), Ve && Te.render(S), Ga(m, S, L);
      P !== null && (A.updateMultisampleRenderTarget(P), A.updateRenderTargetMipmap(P)), S.isScene === !0 && S.onAfterRender(x, S, L), Je.resetDefaultState(), E = -1, v = null, y.pop(), y.length > 0 ? (p = y[y.length - 1], Q === !0 && J.setGlobalState(x.clippingPlanes, p.state.camera)) : p = null, T.pop(), T.length > 0 ? m = T[T.length - 1] : m = null;
    };
    function $r(S, L, H, V) {
    ...
    function Ga(S, L, H, V) {
      const I = S.opaque, ee = S.transmissive, oe = S.transparent;
      p.setupLightsView(H), Q === !0 && J.setGlobalState(x.clippingPlanes, H), V && Ee.viewport(R.copy(V)), I.length > 0 && ji(I, L, H), ee.length > 0 && ji(ee, L, H), oe.length > 0 && ji(oe, L, H), Ee.buffers.depth.setTest(!0), Ee.buffers.depth.setMask(!0), Ee.buffers.color.setMask(!0), Ee.setPolygonOffset(!1);
    }
    function Wa(S, L, H, V) {
      ...
      p.state.transmissionRenderTarget[V.id] === void 0 && (p.state.transmissionRenderTarget[V.id] = new Xn(1, 1, {
        generateMipmaps: !0,
        type: ze.has("EXT_color_buffer_half_float") || ze.has("EXT_color_buffer_float") ? $i : dn,
        minFilter: Gn,
        samples: 4,
        stencilBuffer: s,
      ...
      x.toneMapping = Cn;
      const Ae = V.viewport;
      if (V.viewport !== void 0 && (V.viewport = void 0), p.setupLightsView(V), Q === !0 && J.setGlobalState(x.clippingPlanes, V), ji(S, H, V), A.updateMultisampleRenderTarget(ee), A.updateRenderTargetMipmap(ee), ze.has("WEBGL_multisampled_render_to_texture") === !1) {
        let Pe = !1;
    ...
    function ji(S, L, H) {
      ...
      for (let I = 0, ee = S.length; I < ee; I++) {
        const oe = S[I], me = oe.object, _e = oe.geometry, Ae = V === null ? oe.material : V, Pe = oe.group;
        me.layers.test(H.layers) && Xa(me, L, H, _e, Ae, Pe);
      }
    }
    function Xa(S, L, H, V, I, ee) {
      S.onBeforeRender(x, L, H, V, I, ee), S.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse, S.matrixWorld), S.normalMatrix.getNormalMatrix(S.modelViewMatrix), I.onBeforeRender(x, L, H, V, S, ee), I.transparent === !0 && I.side === Kt && I.forceSinglePass === !1 ? (I.side = Rt, I.needsUpdate = !0, x.renderBufferDirect(H, L, V, I, S, ee), I.side = Pn, I.needsUpdate = !0, x.renderBufferDirect(H, L, V, I, S, ee), I.side = Kt) : x.renderBufferDirect(H, L, V, I, S, ee), S.onAfterRender(x, L, H, V, I, ee);
    }
    function Zi(S, L, H) {
      L.isScene !== !0 && (L = it);
      const V = ye.get(S), I = p.state.lights, ee = p.state.shadowsArray, oe = I.state.version, me = xe.getParameters(S, I.state, ee, L, H), _e = xe.getProgramCacheKey(me);
      let Ae = V.programs;
    ...
    function mh(S, L, H, V, I) {
      ...
      if (Ee.useProgram(Vt.program) && (Kn = !0, Ct = !0, Pi = !0), V.id !== E && (E = V.id, Ct = !0), Kn || v !== S) {
        Ee.buffers.depth.getReversed() ? (ie.copy(S.projectionMatrix), Of(ie), zf(ie), nt.setValue(N, "projectionMatrix", ie)) : nt.setValue(N, "projectionMatrix", S.projectionMatrix), nt.setValue(N, "viewMatrix", S.matrixWorldInverse);
        const pn = nt.map.cameraPosition;
        pn !== void 0 && pn.setValue(N, Re.setFromMatrixPosition(S.matrixWorld)), Be.logarithmicDepthBuffer && nt.setValue(
          N,
          "logDepthBufFC",
          2 / (Math.log(S.far + 1) / Math.LN2)
        ), (V.isMeshPhongMaterial || V.isMeshToonMaterial || V.isMeshLambertMaterial || V.isMeshBasicMaterial || V.isMeshStandardMaterial || V.isShaderMaterial) && nt.setValue(N, "isOrthographic", S.isOrthographicCamera === !0), v !== S && (v = S, Ct = !0, Pi = !0);
      }
      if (I.isSkinnedMesh) {
        nt.setOptional(N, I, "bindMatrix"), nt.setOptional(N, I, "bindMatrixInverse");
        const Nt = I.skeleton;
        Nt && (Nt.boneTexture === null && Nt.computeBoneTexture(), nt.setValue(N, "boneTexture", Nt.boneTexture, A));
      }
      I.isBatchedMesh && (nt.setOptional(N, I, "batchingTexture"), nt.setValue(N, "batchingTexture", I._matricesTexture, A), nt.setOptional(N, I, "batchingIdTexture"), nt.setValue(N, "batchingIdTexture", I._indirectTexture, A), nt.setOptional(N, I, "batchingColorTexture"), I._colorsTexture !== null && nt.setValue(N, "batchingColorTexture", I._colorsTexture, A));
      const Di = H.morphAttributes;
      if ((Di.position !== void 0 || Di.normal !== void 0 || Di.color !== void 0) && be.update(I, H, Vt), (Ct || Me.receiveShadow !== I.receiveShadow) && (Me.receiveShadow = I.receiveShadow, nt.setValue(N, "receiveShadow", I.receiveShadow)), V.isMeshGouraudMaterial && V.envMap !== null && (jt.envMap.value = _e, jt.flipEnvMap.value = _e.isCubeTexture && _e.isRenderTargetTexture === !1 ? -1 : 1), V.isMeshStandardMaterial && V.envMap === null && L.environment !== null && (jt.envMapIntensity.value = L.environmentIntensity), Ct && (nt.setValue(N, "toneMappingExposure", x.toneMappingExposure), Me.needsLights && _h(jt, Pi), ee && V.fog === !0 && se.refreshFogUniforms(jt, ee), se.refreshMaterialUniforms(jt, V, k, K, p.state.transmissionRenderTarget[S.id]), Pr.upload(N, qa(Me), jt, A)), V.isShaderMaterial && V.uniformsNeedUpdate === !0 && (Pr.upload(N, qa(Me), jt, A), V.uniformsNeedUpdate = !1), V.isSpriteMaterial && nt.setValue(N, "center", I.center), nt.setValue(N, "modelViewMatrix", I.modelViewMatrix), nt.setValue(N, "normalMatrix", I.normalMatrix), nt.setValue(N, "modelMatrix", I.matrixWorld), V.isShaderMaterial || V.isRawShaderMaterial) {
        const Nt = V.uniformsGroups;
        for (let pn = 0, mn = Nt.length; pn < mn; pn++) {
          const Ya = Nt[pn];
    ...
    this.getActiveCubeFace = function() {
      ...
      if (S) {
        ...
        S.isWebGLCubeRenderTarget ? (Array.isArray(Pe[L]) ? I = Pe[L][H] : I = Pe[L], ee = !0) : S.samples > 0 && A.useMultisampledRTT(S) === !1 ? I = ye.get(S).__webglMultisampledFramebuffer : Array.isArray(Pe) ? I = Pe[H] : I = Pe, R.copy(S.viewport), z.copy(S.scissor), U = S.scissorTest;
      } else
        R.copy(ve).multiplyScalar(k).floor(), z.copy(Le).multiplyScalar(k).floor(), U = Xe;
      if (Ee.bindFramebuffer(N.FRAMEBUFFER, I) && V && Ee.drawBuffers(S, I), Ee.viewport(R), Ee.scissor(z), Ee.setScissorTest(U), ee) {
      ...
      E = -1;
    }, this.readRenderTargetPixels = function(S, L, H, V, I, ee, oe) {
      ...
      if (S.isWebGLCubeRenderTarget && oe !== void 0 && (me = me[oe]), me) {
        ...
        try {
          ...
          L >= 0 && L <= S.width - V && H >= 0 && H <= S.height - I && N.readPixels(L, H, V, I, Ie.convert(Ae), Ie.convert(Pe), ee);
        } finally {
          const _e = P !== null ? ye.get(P).__webglFramebuffer : null;
          Ee.bindFramebuffer(N.FRAMEBUFFER, _e);
        }
      }
    }, this.readRenderTargetPixelsAsync = async function(S, L, H, V, I, ee, oe) {
      if (!(S && S.isWebGLRenderTarget))
      ...
      if (S.isWebGLCubeRenderTarget && oe !== void 0 && (me = me[oe]), me) {
        ...
        if (L >= 0 && L <= S.width - V && H >= 0 && H <= S.height - I) {
          Ee.bindFramebuffer(N.FRAMEBUFFER, me);
          const ge = N.createBuffer();
          N.bindBuffer(N.PIXEL_PACK_BUFFER, ge), N.bufferData(N.PIXEL_PACK_BUFFER, ee.byteLength, N.STREAM_READ), N.readPixels(L, H, V, I, Ie.convert(Ae), Ie.convert(Pe), 0);
          const We = P !== null ? ye.get(P).__webglFramebuffer : null;
          Ee.bindFramebuffer(N.FRAMEBUFFER, We);
          const Qe = N.fenceSync(N.SYNC_GPU_COMMANDS_COMPLETE, 0);
          return N.flush(), await Ff(N, Qe, 4), N.bindBuffer(N.PIXEL_PACK_BUFFER, ge), N.getBufferSubData(N.PIXEL_PACK_BUFFER, 0, ee), N.deleteBuffer(ge), N.deleteSync(Qe), ee;
        } else
          throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.");
      }
    }, this.copyFramebufferToTexture = function(S, L = null, H = 0) {
      S.isTexture !== !0 && (Hi("WebGLRenderer: copyFramebufferToTexture function signature has changed."), L = arguments[0] || null, S = arguments[1]);
      const V = Math.pow(2, -H), I = Math.floor(S.image.width * V), ee = Math.floor(S.image.height * V), oe = L !== null ? L.x : 0, me = L !== null ? L.y : 0;
      A.setTexture2D(S, 0), N.copyTexSubImage2D(N.TEXTURE_2D, H, 0, 0, oe, me, I, ee), Ee.unbindTexture();
    }, this.copyTextureToTexture = function(S, L, H = null, V = null, I = 0) {
      S.isTexture !== !0 && (Hi("WebGLRenderer: copyTextureToTexture function signature has changed."), V = arguments[0] || null, S = arguments[1], L = arguments[2], I = arguments[3] || 0, H = null);
      let ee, oe, me, _e, Ae, Pe, ge, We, Qe;
      const tt = S.isCompressedTexture ? S.mipmaps[I] : S.image;
      ...
      const nn = N.getParameter(N.UNPACK_ROW_LENGTH), $e = N.getParameter(N.UNPACK_IMAGE_HEIGHT), Vt = N.getParameter(N.UNPACK_SKIP_PIXELS), Kn = N.getParameter(N.UNPACK_SKIP_ROWS), Ct = N.getParameter(N.UNPACK_SKIP_IMAGES);
      N.pixelStorei(N.UNPACK_ROW_LENGTH, tt.width), N.pixelStorei(N.UNPACK_IMAGE_HEIGHT, tt.height), N.pixelStorei(N.UNPACK_SKIP_PIXELS, _e), N.pixelStorei(N.UNPACK_SKIP_ROWS, Ae), N.pixelStorei(N.UNPACK_SKIP_IMAGES, Pe);
      const Pi = S.isDataArrayTexture || S.isData3DTexture, nt = L.isDataArrayTexture || L.isData3DTexture;
      if (S.isRenderTargetTexture || S.isDepthTexture) {
        const jt = ye.get(S), Di = ye.get(L), Nt = ye.get(jt.__renderTarget), pn = ye.get(Di.__renderTarget);
        Ee.bindFramebuffer(N.READ_FRAMEBUFFER, Nt.__webglFramebuffer), Ee.bindFramebuffer(N.DRAW_FRAMEBUFFER, pn.__webglFramebuffer);
        for (let mn = 0; mn < me; mn++)
          Pi && N.framebufferTextureLayer(N.READ_FRAMEBUFFER, N.COLOR_ATTACHMENT0, ye.get(S).__webglTexture, I, Pe + mn), S.isDepthTexture ? (nt && N.framebufferTextureLayer(N.DRAW_FRAMEBUFFER, N.COLOR_ATTACHMENT0, ye.get(L).__webglTexture, I, Qe + mn), N.blitFramebuffer(_e, Ae, ee, oe, ge, We, ee, oe, N.DEPTH_BUFFER_BIT, N.NEAREST)) : nt ? N.copyTexSubImage3D(Me, I, ge, We, Qe + mn, _e, Ae, ee, oe) : N.copyTexSubImage2D(Me, I, ge, We, Qe + mn, _e, Ae, ee, oe);
        Ee.bindFramebuffer(N.READ_FRAMEBUFFER, null), Ee.bindFramebuffer(N.DRAW_FRAMEBUFFER, null);
      } else
        nt ? S.isDataTexture || S.isData3DTexture ? N.texSubImage3D(Me, I, ge, We, Qe, ee, oe, me, Et, qe, tt.data) : L.isCompressedArrayTexture ? N.compressedTexSubImage3D(Me, I, ge, We, Qe, ee, oe, me, Et, tt.data) : N.texSubImage3D(Me, I, ge, We, Qe, ee, oe, me, Et, qe, tt) : S.isDataTexture ? N.texSubImage2D(N.TEXTURE_2D, I, ge, We, ee, oe, Et, qe, tt.data) : S.isCompressedTexture ? N.compressedTexSubImage2D(N.TEXTURE_2D, I, ge, We, tt.width, tt.height, Et, tt.data) : N.texSubImage2D(N.TEXTURE_2D, I, ge, We, ee, oe, Et, qe, tt);
      N.pixelStorei(N.UNPACK_ROW_LENGTH, nn), N.pixelStorei(N.UNPACK_IMAGE_HEIGHT, $e), N.pixelStorei(N.UNPACK_SKIP_PIXELS, Vt), N.pixelStorei(N.UNPACK_SKIP_ROWS, Kn), N.pixelStorei(N.UNPACK_SKIP_IMAGES, Ct), I === 0 && L.generateMipmaps && N.generateMipmap(Me), Ee.unbindTexture();
    }, this.copyTextureToTexture3D = function(S, L, H = null, V = null, I = 0) {
      return S.isTexture !== !0 && (Hi("WebGLRenderer: copyTextureToTexture3D function signature has changed."), H = arguments[0] || null, V = arguments[1] || null, S = arguments[2], L = arguments[3], I = arguments[4] || 0), Hi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'), this.copyTextureToTexture(S, L, H, V, I);
  ...
  raycast(e, n) {
    ...
    if (h !== null) {
      ...
      for (let g = u, m = _ - 1; g < m; g += l) {
        const p = h.getX(g), T = h.getX(g + 1), y = Mr(this, e, Bi, c, p, T);
        y && n.push(y);
      }
      if (this.isLineLoop) {
        const g = h.getX(_ - 1), m = h.getX(u), p = Mr(this, e, Bi, c, g, m);
        p && n.push(p);
      }
    } else {
  ...
  constructor(e = 1, n = 1, i = 1, r = 32, s = 1, a = !1, o = 0, c = Math.PI * 2) {
    ...
    function T() {
      ...
      for (let P = 0; P <= s; P++) {
        ...
        for (let z = 0; z <= r; z++) {
          const U = z / r, F = U * c + o, X = Math.sin(F), G = Math.cos(F);
          C.x = R * X, C.y = -v * i + m, C.z = R * G, f.push(C.x, C.y, C.z), x.set(X, w, G).normalize(), d.push(x.x, x.y, x.z), u.push(U, 1 - v), E.push(_++);
        }
        g.push(E);
      }
      for (let P = 0; P < r; P++)
        for (let E = 0; E < s; E++) {
          const v = g[E][P], R = g[E + 1][P], z = g[E + 1][P + 1], U = g[E][P + 1];
          (e > 0 || E !== 0) && (h.push(v, R, U), b += 3), (n > 0 || E !== s - 1) && (h.push(R, z, U), b += 3);
        }
    ...
    function y(x) {
      ...
      for (let z = 0; z < r; z++) {
        const U = C + z, F = R + z;
        x === !0 ? h.push(F, F + 1, U) : h.push(F + 1, F, U), P += 3;
      }
...
async function rl(t, e) {
  ...
  for (const f of r) {
    const d = i.get(f), u = new zr({ pos: d });
    s.set(f, u);
  }
...
function dv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], m = e[14], p = e[15], T = n * o - i * a, y = n * c - r * a, x = n * l - s * a, C = i * c - r * o, b = i * l - s * o, w = r * l - s * c, P = h * g - f * _, E = h * m - d * _, v = h * p - u * _, R = f * m - d * g, z = f * p - u * g, U = d * p - u * m, F = T * U - y * z + x * R + C * v - b * E + w * P;
  return F ? (F = 1 / F, t[0] = (o * U - c * z + l * R) * F, t[1] = (c * v - a * U - l * E) * F, t[2] = (a * z - o * v + l * P) * F, t[3] = (r * z - i * U - s * R) * F, t[4] = (n * U - r * v + s * E) * F, t[5] = (i * v - n * z - s * P) * F, t[6] = (g * w - m * b + p * C) * F, t[7] = (m * x - _ * w - p * y) * F, t[8] = (_ * b - g * x + p * T) * F, t) : null;
}
function uv(t, e, n) {
...
function Pv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], m = e[14], p = e[15], T = n * o - i * a, y = n * c - r * a, x = n * l - s * a, C = i * c - r * o, b = i * l - s * o, w = r * l - s * c, P = h * g - f * _, E = h * m - d * _, v = h * p - u * _, R = f * m - d * g, z = f * p - u * g, U = d * p - u * m, F = T * U - y * z + x * R + C * v - b * E + w * P;
  return F ? (F = 1 / F, t[0] = (o * U - c * z + l * R) * F, t[1] = (r * z - i * U - s * R) * F, t[2] = (g * w - m * b + p * C) * F, t[3] = (d * b - f * w - u * C) * F, t[4] = (c * v - a * U - l * E) * F, t[5] = (n * U - r * v + s * E) * F, t[6] = (m * x - _ * w - p * y) * F, t[7] = (h * w - d * x + u * y) * F, t[8] = (a * z - o * v + l * P) * F, t[9] = (i * v - n * z - s * P) * F, t[10] = (_ * b - g * x + p * T) * F, t[11] = (f * x - h * b - u * T) * F, t[12] = (o * E - a * R - c * P) * F, t[13] = (n * R - i * E + r * P) * F, t[14] = (g * y - _ * C - m * T) * F, t[15] = (h * C - f * y + d * T) * F, t) : null;
}
function Dv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], m = e[14], p = e[15], T = n * o - i * a, y = n * c - r * a, x = n * l - s * a, C = i * c - r * o, b = i * l - s * o, w = r * l - s * c, P = h * g - f * _, E = h * m - d * _, v = h * p - u * _, R = f * m - d * g, z = f * p - u * g, U = d * p - u * m;
  return t[0] = o * U - c * z + l * R, t[1] = r * z - i * U - s * R, t[2] = g * w - m * b + p * C, t[3] = d * b - f * w - u * C, t[4] = c * v - a * U - l * E, t[5] = n * U - r * v + s * E, t[6] = m * x - _ * w - p * y, t[7] = h * w - d * x + u * y, t[8] = a * z - o * v + l * P, t[9] = i * v - n * z - s * P, t[10] = _ * b - g * x + p * T, t[11] = f * x - h * b - u * T, t[12] = o * E - a * R - c * P, t[13] = n * R - i * E + r * P, t[14] = g * y - _ * C - m * T, t[15] = h * C - f * y + d * T, t;
}
function Lv(t) {
...
function Yv(t, e, n, i, r) {
  var s = e[0], a = e[1], o = e[2], c = e[3], l = s + s, h = a + a, f = o + o, d = s * l, u = s * h, _ = s * f, g = a * h, m = a * f, p = o * f, T = c * l, y = c * h, x = c * f, C = i[0], b = i[1], w = i[2], P = r[0], E = r[1], v = r[2], R = (1 - (g + p)) * C, z = (u + x) * C, U = (_ - y) * C, F = (u - x) * b, X = (1 - (d + p)) * b, G = (m + T) * b, K = (_ + y) * w, k = (m - T) * w, te = (1 - (d + g)) * w;
  return t[0] = R, t[1] = z, t[2] = U, t[3] = 0, t[4] = F, t[5] = X, t[6] = G, t[7] = 0, t[8] = K, t[9] = k, t[10] = te, t[11] = 0, t[12] = n[0] + P - (R * P + F * E + K * v), t[13] = n[1] + E - (z * P + X * E + k * v), t[14] = n[2] + v - (U * P + G * E + te * v), t[15] = 1, t;
}
function jv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = n + n, o = i + i, c = r + r, l = n * a, h = i * a, f = i * o, d = r * a, u = r * o, _ = r * c, g = s * a, m = s * o, p = s * c;
...
function hx(t, e) {
  var n = t[0], i = t[1], r = t[2], s = t[3], a = t[4], o = t[5], c = t[6], l = t[7], h = t[8], f = t[9], d = t[10], u = t[11], _ = t[12], g = t[13], m = t[14], p = t[15], T = e[0], y = e[1], x = e[2], C = e[3], b = e[4], w = e[5], P = e[6], E = e[7], v = e[8], R = e[9], z = e[10], U = e[11], F = e[12], X = e[13], G = e[14], K = e[15];
  return Math.abs(n - T) <= pe * Math.max(1, Math.abs(n), Math.abs(T)) && Math.abs(i - y) <= pe * Math.max(1, Math.abs(i), Math.abs(y)) && Math.abs(r - x) <= pe * Math.max(1, Math.abs(r), Math.abs(x)) && Math.abs(s - C) <= pe * Math.max(1, Math.abs(s), Math.abs(C)) && Math.abs(a - b) <= pe * Math.max(1, Math.abs(a), Math.abs(b)) && Math.abs(o - w) <= pe * Math.max(1, Math.abs(o), Math.abs(w)) && Math.abs(c - P) <= pe * Math.max(1, Math.abs(c), Math.abs(P)) && Math.abs(l - E) <= pe * Math.max(1, Math.abs(l), Math.abs(E)) && Math.abs(h - v) <= pe * Math.max(1, Math.abs(h), Math.abs(v)) && Math.abs(f - R) <= pe * Math.max(1, Math.abs(f), Math.abs(R)) && Math.abs(d - z) <= pe * Math.max(1, Math.abs(d), Math.abs(z)) && Math.abs(u - U) <= pe * Math.max(1, Math.abs(u), Math.abs(U)) && Math.abs(_ - F) <= pe * Math.max(1, Math.abs(_), Math.abs(F)) && Math.abs(g - X) <= pe * Math.max(1, Math.abs(g), Math.abs(X)) && Math.abs(m - G) <= pe * Math.max(1, Math.abs(m), Math.abs(G)) && Math.abs(p - K) <= pe * Math.max(1, Math.abs(p), Math.abs(K));
}
var fx = pl, dx = yl;
...
async function Sy(t, e = {}) {
  ...
  i.forEach((u, _) => s.set(u, _));
  const a = await dy(t, i);
  a.length;
  const o = new Float32Array(r * 3);
  for (let u = 0; u < r; u++)
    o[u * 3] = (Math.random() * 2 - 1) * n.simulationBound, o[u * 3 + 1] = (Math.random() * 2 - 1) * n.simulationBound, o[u * 3 + 2] = (Math.random() * 2 - 1) * n.simulationBound;
  const c = {
    pi: Sn.create(),
    pj: Sn.create(),
    diff: Sn.create()
  ...
  function h(u) {
    ...
    for (let g = 0; g < _ && a.length !== 0; g++) {
      const m = a[Math.floor(Math.random() * a.length)], { i: p, j: T, d: y, w: x } = m;
      Sn.set(c.pi, o[p * 3], o[p * 3 + 1], o[p * 3 + 2]), Sn.set(c.pj, o[T * 3], o[T * 3 + 1], o[T * 3 + 2]), Sn.subtract(c.diff, c.pj, c.pi);
      const C = Math.max(Sn.length(c.diff), l), b = n.learningRate * 2 * x * (y - C) / C;
      Sn.scale(c.diff, c.diff, b), o[p * 3] += c.diff[0], o[p * 3 + 1] += c.diff[1], o[p * 3 + 2] += c.diff[2], o[T * 3] -= c.diff[0], o[T * 3 + 1] -= c.diff[1], o[T * 3 + 2] -= c.diff[2];
    }
  }
  function f() {
    return o;
  ...
  function d() {
    ...
    for (let _ = 0; _ < r; _++)
      u.set(
        i[_],
        new Lt(o[_ * 3], o[_ * 3 + 1], o[_ * 3 + 2])
      );
    return u;
  }
  return { step: h, getPositions: f, getPositionMap: d };
}
export {
  Eh as Constructors,
  Vh as Drawing,
