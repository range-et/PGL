...
#define LOW_PRECISION`),e}function h0(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===mc?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===$h?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===ln&&(e="SHADOWMAP_TYPE_VSM"),e}function f0(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case yi:case Si:e="ENVMAP_TYPE_CUBE";break;case Hr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function d0(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case Si:e="ENVMAP_MODE_REFRACTION";break}return e}function u0(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case _c:e="ENVMAP_BLENDING_MULTIPLY";break;case uf:e="ENVMAP_BLENDING_MIX";break;case pf:e="ENVMAP_BLENDING_ADD";break}return e}function p0(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function m0(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const c=h0(n),l=f0(n),h=d0(n),f=u0(n),d=p0(n),u=n0(n),_=i0(s),g=r.createProgram();let m,p,T=n.glslVersion?"#version "+n.glslVersion+`
...
`)+`
`+p);const y=T+m+a,x=T+p+o,C=zo(r,r.VERTEX_SHADER,y),b=zo(r,r.FRAGMENT_SHADER,x);r.attachShader(g,C),r.attachShader(g,b),n.index0AttributeName!==void 0?r.bindAttribLocation(g,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function w(R){if(t.debug.checkShaderErrors){const z=r.getProgramInfoLog(g).trim(),U=r.getShaderInfoLog(C).trim(),F=r.getShaderInfoLog(b).trim();let X=!0,G=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(X=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,g,C,b);else{const K=Ho(r,C,"vertex"),k=Ho(r,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
