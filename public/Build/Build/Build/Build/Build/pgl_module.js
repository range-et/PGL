...
async function Dh(t, e, n = 100, i = 1, r = 1) {
  ...
  const g = At.calculateAverage(f), m = At.calculateAverage(d), p = At.calculateAverage(u), T = new Rt(
    -g,
    -m,
    -p
  );
...
async function Fh(t, e, n, i) {
  ...
  for (const _ of r.keys()) {
    const g = s.get(_) * n, m = o.get(s.get(_)), p = 2 * Math.PI * (m.indexOf(_) / m.length), T = Math.sin(p) * g, S = Math.cos(p) * g, v = new Rt(T + l, -g + h, S + f);
    c.set(_, v);
  }
...
class De {
  ...
  multiplyMatrices(e, n) {
    const i = e.elements, r = n.elements, s = this.elements, a = i[0], o = i[3], c = i[6], l = i[1], h = i[4], f = i[7], d = i[2], u = i[5], _ = i[8], g = r[0], m = r[3], p = r[6], T = r[1], S = r[4], v = r[7], P = r[2], b = r[5], w = r[8];
    return s[0] = a * g + o * T + c * P, s[3] = a * m + o * S + c * b, s[6] = a * p + o * v + c * w, s[1] = l * g + h * T + f * P, s[4] = l * m + h * S + f * b, s[7] = l * p + h * v + f * w, s[2] = d * g + u * T + _ * P, s[5] = d * m + u * S + _ * b, s[8] = d * p + u * v + _ * w, this;
  }
  multiplyScalar(e) {
...
class st {
  ...
  setAxisAngleFromRotationMatrix(e) {
    ...
    if (Math.abs(h - d) < 0.01 && Math.abs(f - g) < 0.01 && Math.abs(_ - m) < 0.01) {
      ...
      n = Math.PI;
      const S = (l + 1) / 2, v = (u + 1) / 2, P = (p + 1) / 2, b = (h + d) / 4, w = (f + g) / 4, R = (_ + m) / 4;
...
class Dn {
  ...
  static slerpFlat(e, n, i, r, s, a, o) {
    ...
    if (f !== g || c !== d || l !== u || h !== _) {
      let m = 1 - o;
      const p = c * d + l * u + h * _ + f * g, T = p >= 0 ? 1 : -1, S = 1 - p * p;
      if (S > Number.EPSILON) {
        const P = Math.sqrt(S), b = Math.atan2(P, p * T);
        m = Math.sin(m * b) / P, o = Math.sin(o * b) / P;
      }
      const v = o * T;
      if (c = c * m + d * v, l = l * m + u * v, h = h * m + _ * v, f = f * m + g * v, m === 1 - o) {
...
class Ke {
  ...
  multiplyMatrices(e, n) {
    const i = e.elements, r = n.elements, s = this.elements, a = i[0], o = i[4], c = i[8], l = i[12], h = i[1], f = i[5], d = i[9], u = i[13], _ = i[2], g = i[6], m = i[10], p = i[14], T = i[3], S = i[7], v = i[11], P = i[15], b = r[0], w = r[4], R = r[8], y = r[12], x = r[1], C = r[5], z = r[9], I = r[13], N = r[2], X = r[6], G = r[10], K = r[14], k = r[3], te = r[7], le = r[11], ve = r[15];
    return s[0] = a * b + o * x + c * N + l * k, s[4] = a * w + o * C + c * X + l * te, s[8] = a * R + o * z + c * G + l * le, s[12] = a * y + o * I + c * K + l * ve, s[1] = h * b + f * x + d * N + u * k, s[5] = h * w + f * C + d * X + u * te, s[9] = h * R + f * z + d * G + u * le, s[13] = h * y + f * I + d * K + u * ve, s[2] = _ * b + g * x + m * N + p * k, s[6] = _ * w + g * C + m * X + p * te, s[10] = _ * R + g * z + m * G + p * le, s[14] = _ * y + g * I + m * K + p * ve, s[3] = T * b + S * x + v * N + P * k, s[7] = T * w + S * C + v * X + P * te, s[11] = T * R + S * z + v * G + P * le, s[15] = T * y + S * I + v * K + P * ve, this;
  }
  multiplyScalar(e) {
    const n = this.elements;
  ...
  invert() {
    const e = this.elements, n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], m = e[14], p = e[15], T = f * m * l - g * d * l + g * c * u - o * m * u - f * c * p + o * d * p, S = _ * d * l - h * m * l - _ * c * u + a * m * u + h * c * p - a * d * p, v = h * g * l - _ * f * l + _ * o * u - a * g * u - h * o * p + a * f * p, P = _ * f * c - h * g * c - _ * o * d + a * g * d + h * o * m - a * f * m, b = n * T + i * S + r * v + s * P;
  ...
  compose(e, n, i) {
    const r = this.elements, s = n._x, a = n._y, o = n._z, c = n._w, l = s + s, h = a + a, f = o + o, d = s * l, u = s * h, _ = s * f, g = a * h, m = a * f, p = o * f, T = c * l, S = c * h, v = c * f, P = i.x, b = i.y, w = i.z;
    return r[0] = (1 - (g + p)) * P, r[1] = (u + v) * P, r[2] = (_ - S) * P, r[3] = 0, r[4] = (u - v) * b, r[5] = (1 - (d + p)) * b, r[6] = (m + T) * b, r[7] = 0, r[8] = (_ + S) * w, r[9] = (m - T) * w, r[10] = (1 - (d + g)) * w, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, this;
  }
  decompose(e, n, i) {
    const r = this.elements;
...
class Xt {
  ...
  closestPointToPoint(e, n) {
    ...
    const p = 1 / (m + g + d);
    return a = g * p, o = d * p, n.copy(i).addScaledVector(ai, a).addScaledVector(oi, o);
  }
  equals(e) {
...
class pt extends $n {
  ...
  computeTangents() {
    ...
    function p(R, y, x) {
      l.fromBufferAttribute(i, R), h.fromBufferAttribute(i, y), f.fromBufferAttribute(i, x), d.fromBufferAttribute(s, R), u.fromBufferAttribute(s, y), _.fromBufferAttribute(s, x), h.sub(l), f.sub(l), u.sub(d), _.sub(d);
      const C = 1 / (u.x * _.y - _.x * u.y);
      isFinite(C) && (g.copy(h).multiplyScalar(_.y).addScaledVector(f, -u.y).multiplyScalar(C), m.copy(f).multiplyScalar(u.x).addScaledVector(h, -_.x).multiplyScalar(C), o[R].add(g), o[y].add(g), o[x].add(g), c[R].add(m), c[y].add(m), c[x].add(m));
    }
    let T = this.groups;
    T.length === 0 && (T = [{
      start: 0,
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let _ = 0, g = d.length; _ < g; _++) {
          const m = d[_], p = a[m.materialIndex], T = Math.max(m.start, u.start), S = Math.min(o.count, Math.min(m.start + m.count, u.start + u.count));
          for (let v = T, P = S; v < P; v += 3) {
            const b = o.getX(v), w = o.getX(v + 1), R = o.getX(v + 2);
            r = pr(this, p, e, i, l, h, f, b, w, R), r && (r.faceIndex = Math.floor(v / 3), r.face.materialIndex = m.materialIndex, n.push(r));
          }
        }
      else {
        ...
        for (let m = _, p = g; m < p; m += 3) {
          ...
          r = pr(this, a, e, i, l, h, f, T, S, v), r && (r.faceIndex = Math.floor(m / 3), n.push(r));
        }
      }
    else if (c !== void 0)
      if (Array.isArray(a))
        for (let _ = 0, g = d.length; _ < g; _++) {
          const m = d[_], p = a[m.materialIndex], T = Math.max(m.start, u.start), S = Math.min(c.count, Math.min(m.start + m.count, u.start + u.count));
          for (let v = T, P = S; v < P; v += 3) {
...
class wa {
  ...
  setFromProjectionMatrix(e, n = fn) {
    const i = this.planes, r = e.elements, s = r[0], a = r[1], o = r[2], c = r[3], l = r[4], h = r[5], f = r[6], d = r[7], u = r[8], _ = r[9], g = r[10], m = r[11], p = r[12], T = r[13], S = r[14], v = r[15];
    if (i[0].setComponents(c - s, d - l, m - u, v - p).normalize(), i[1].setComponents(c + s, d + l, m + u, v + p).normalize(), i[2].setComponents(c + a, d + h, m + _, v + T).normalize(), i[3].setComponents(c - a, d - h, m - _, v - T).normalize(), i[4].setComponents(c - o, d - f, m - g, v - S).normalize(), n === fn)
      i[5].setComponents(c + o, d + f, m + g, v + S).normalize();
    else if (n === Ur)
...
function Wp(t, e, n, i, r, s, a) {
  ...
  function m(T, S) {
    ...
    }), r.update(h)), zn.copy(S.backgroundRotation), zn.x *= -1, zn.y *= -1, zn.z *= -1, v.isCubeTexture && v.isRenderTargetTexture === !1 && (zn.y *= -1, zn.z *= -1), h.material.uniforms.envMap.value = v, h.material.uniforms.flipEnvMap.value = v.isCubeTexture && v.isRenderTargetTexture === !1 ? -1 : 1, h.material.uniforms.backgroundBlurriness.value = S.backgroundBlurriness, h.material.uniforms.backgroundIntensity.value = S.backgroundIntensity, h.material.uniforms.backgroundRotation.value.setFromMatrix4(Gp.makeRotationFromEuler(zn)), h.material.toneMapped = Ge.getTransfer(v.colorSpace) !== je, (f !== v || d !== v.version || u !== t.toneMapping) && (h.material.needsUpdate = !0, f = v, d = v.version, u = t.toneMapping), h.layers.enableAll(), T.unshift(h, h.geometry, h.material, 0, 0, null)) : v && v.isTexture && (l === void 0 && (l = new wt(
      new kr(2, 2),
      new Yt({
    ...
    }), r.update(l)), l.material.uniforms.t2D.value = v, l.material.uniforms.backgroundIntensity.value = S.backgroundIntensity, l.material.toneMapped = Ge.getTransfer(v.colorSpace) !== je, v.matrixAutoUpdate === !0 && v.updateMatrix(), l.material.uniforms.uvTransform.value.copy(v.matrix), (f !== v || d !== v.version || u !== t.toneMapping) && (l.material.needsUpdate = !0, f = v, d = v.version, u = t.toneMapping), l.layers.enableAll(), T.unshift(l, l.geometry, l.material, 0, 0, null));
  }
  function p(T, S) {
...
function Xp(t, e) {
  ...
  function o(x, C, z, I, N) {
    let X = !1;
    const G = f(I, z, C);
    s !== G && (s = G, l(s.object)), X = u(x, I, z, N), X && _(x, I, z, N), N !== null && e.update(N, t.ELEMENT_ARRAY_BUFFER), (X || a) && (a = !1, v(x, C, z, I), N !== null && t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, e.get(N).buffer));
  }
  function c() {
...
function $p(t, e, n, i) {
  ...
  function o(w) {
    const R = w === Yi && (e.has("EXT_color_buffer_half_float") || e.has("EXT_color_buffer_float"));
...
class Ao {
  ...
  _sceneToCubeUV(e, n, i, r) {
    ...
    m ? m.isColor && (u.color.copy(m), e.background = null, g = !0) : (u.color.copy(To), g = !0);
    for (let p = 0; p < 6; p++) {
      const T = p % 3;
      T === 0 ? (o.up.set(0, c[p], 0), o.lookAt(l[p], 0, 0)) : T === 1 ? (o.up.set(0, 0, c[p]), o.lookAt(0, l[p], 0)) : (o.up.set(0, c[p], 0), o.lookAt(0, 0, l[p]));
      const S = this._cubeSize;
      gr(r, T * S, p > 2 ? S : 0, S, S), h.setRenderTarget(r), g && h.render(_, o), h.render(e, o);
    }
  ...
  _halfBlur(e, n, i, r, s, a, o) {
    ...
    const h = 3, f = new wt(this._lodPlanes[r], l), d = l.uniforms, u = this._sizeLods[i] - 1, _ = isFinite(s) ? Math.PI / (2 * u) : 2 * Math.PI / (2 * kn - 1), g = s / _, m = isFinite(s) ? 1 + Math.floor(h * g) : kn;
    ...
    gr(n, P, b, 3 * v, 2 * v), c.setRenderTarget(n), c.render(f, _s);
  }
}
function Zp(t) {
  const e = [], n = [], i = [];
  ...
  for (let a = 0; a < s; a++) {
    ...
    const l = 1 / (o - 2), h = -l, f = 1 + l, d = [h, h, f, h, f, f, h, h, f, f, h, f], u = 6, _ = 6, g = 3, m = 2, p = 1, T = new Float32Array(g * _ * u), S = new Float32Array(m * _ * u), v = new Float32Array(p * _ * u);
    for (let b = 0; b < u; b++) {
    ...
    if (d === void 0 || d.count !== f) {
      ...
      for (let x = 0; x < f; x++) {
        ...
        for (let X = 0; X < C.count; X++) {
          const G = X * R;
          u === !0 && (r.fromBufferAttribute(C, X), b[N + G + 0] = r.x, b[N + G + 1] = r.y, b[N + G + 2] = r.z, b[N + G + 3] = 0), _ === !0 && (r.fromBufferAttribute(z, X), b[N + G + 4] = r.x, b[N + G + 5] = r.y, b[N + G + 6] = r.z, b[N + G + 7] = 0), g === !0 && (r.fromBufferAttribute(I, X), b[N + G + 8] = r.x, b[N + G + 9] = r.y, b[N + G + 10] = r.z, b[N + G + 11] = I.itemSize === 4 ? r.w : 1);
        }
      }
      d = {
        count: f,
...
` + k
    ...
    r.deleteShader(P), r.deleteShader(b), R = new Dr(r, g), y = r0(r, g);
  }
  let R;
  ...
  return this.isReady = function() {
    return x === !1 && (x = r.getProgramParameter(g, jm)), x;
  }, this.destroy = function() {
    i.releaseStatesOfProgram(this), r.deleteProgram(g), this.program = void 0;
  }, this.type = n.shaderType, this.name = n.shaderName, this.id = Zm++, this.cacheKey = e, this.usedTimes = 1, this.program = g, this.vertexShader = P, this.fragmentShader = b, this;
}
let _0 = 0;
class g0 {
  constructor() {
...
function x0(t, e, n, i, r, s, a) {
  ...
  function P(y, x) {
    ...
    return C === void 0 && (C = new m0(t, x, y, s), h.push(C)), C;
  }
  function b(y) {
    if (--y.usedTimes === 0) {
      const x = h.indexOf(y);
...
function w0(t) {
  ...
  function o(l) {
    ...
    let u = 0, _ = 0, g = 0, m = 0, p = 0, T = 0, S = 0, v = 0, P = 0, b = 0, w = 0;
    l.sort(A0);
  ...
  function c(l, h) {
    ...
    for (let p = 0, T = l.length; p < T; p++) {
      ...
      if (S.isDirectionalLight) {
        ...
        const v = i.spot[u];
        v.position.setFromMatrixPosition(S.matrixWorld), v.position.applyMatrix4(m), v.direction.setFromMatrixPosition(S.matrixWorld), r.setFromMatrixPosition(S.target.matrixWorld), v.direction.sub(r), v.direction.transformDirection(m), u++;
        ...
        const v = i.point[d];
        v.position.setFromMatrixPosition(S.matrixWorld), v.position.applyMatrix4(m), d++;
...
function N0(t, e) {
  ...
  let h = {}, f = {}, d = /* @__PURE__ */ new WeakMap(), u = [], _ = null, g = !1, m = null, p = null, T = null, S = null, v = null, P = null, b = null, w = new Oe(0, 0, 0), R = 0, y = !1, x = null, C = null, z = null, I = null, N = null;
  ...
  function F(D, re, W, j, ce, ae, Ce, rt, mt, Ye) {
    ...
    if (g === !1 && (ie(t.BLEND), g = !0), D !== Yh) {
      if (D !== m || Ye !== y) {
        if ((p !== Vn || v !== Vn) && (t.blendEquation(t.FUNC_ADD), p = Vn, v = Vn), Ye)
          switch (D) {
            case gi:
...
class W0 extends $n {
  constructor(e, n) {
    ...
    const g = new G0(), m = n.getContextAttributes();
    let p = null, T = null;
    const S = [], v = [], P = new we();
    let b = null;
    const w = new zt();
    ...
    function N() {
      ...
      C = null, z = null, g.reset(), e.setRenderTarget(p), u = null, d = null, f = null, r = null, T = null, Xe.stop(), i.isPresenting = !1, e.setPixelRatio(b), e.setSize(P.width, P.height, !1), i.dispatchEvent({ type: "sessionend" });
    }
    this.setFramebufferScaleFactor = function(q) {
      ...
      if (r = q, r !== null) {
        if (p = e.getRenderTarget(), r.addEventListener("select", I), r.addEventListener("selectstart", I), r.addEventListener("selectend", I), r.addEventListener("squeeze", I), r.addEventListener("squeezestart", I), r.addEventListener("squeezeend", I), r.addEventListener("end", N), r.addEventListener("inputsourceschange", X), m.xrCompatible !== !0 && await n.makeXRCompatible(), b = e.getPixelRatio(), e.getSize(P), r.renderState.layers === void 0) {
          ...
          m.depth && (ie = m.stencil ? n.DEPTH24_STENCIL8 : n.DEPTH_COMPONENT24, Q = m.stencil ? Ti : vi, he = m.stencil ? Ei : Xn);
          const Se = {
            colorFormat: n.RGBA8,
            depthFormat: ie,
            scaleFactor: s
...
class Y0 {
  constructor(e = {}) {
    ...
    function re() {
      ze = new Qp(F), ze.init(), Ie = new z0(F, ze), Be = new $p(F, ze, e, Ie), Ee = new N0(F, ze), Be.reverseDepthBuffer && d && Ee.buffers.depth.setReversed(!0), et = new nm(F), ye = new M0(), A = new O0(F, ze, Ee, ye, Be, Ie, et), M = new jp(v), B = new Jp(v), Y = new ld(F), Je = new Xp(F, Y), Z = new em(F, Y, et, Je), $ = new rm(F, Z, Y, et), be = new im(F, Be, A), J = new Yp(ye), xe = new x0(v, M, B, ze, Be, Je, J), se = new q0(v, ye), fe = new S0(), ke = new R0(ze), Te = new Wp(v, M, B, Ee, $, u, c), de = new I0(v, $, Be), D = new $0(F, et, Be, Ee), ue = new qp(F, ze, et), He = new tm(F, ze, et), et.programs = xe.programs, v.capabilities = Be, v.extensions = ze, v.properties = ye, v.renderLists = fe, v.shadowMap = de, v.state = Ee, v.info = et;
    }
    re();
    const W = new W0(v, F);
    this.xr = W, this.getContext = function() {
      ...
      if (E) {
        ...
        if (U) {
          const ee = R.texture.type, oe = ee === un || ee === Xn || ee === Wi || ee === Ei || ee === ya || ee === Sa, me = Te.getClearColor(), _e = Te.getClearAlpha(), Ae = me.r, Pe = me.g, ge = me.b;
    ...
    function Ga(E, L, H, V) {
      ...
      p.setupLightsView(H), Q === !0 && J.setGlobalState(v.clippingPlanes, H), V && Ee.viewport(C.copy(V)), U.length > 0 && Zi(U, L, H), ee.length > 0 && Zi(ee, L, H), oe.length > 0 && Zi(oe, L, H), Ee.buffers.depth.setTest(!0), Ee.buffers.depth.setMask(!0), Ee.buffers.color.setMask(!0), Ee.setPolygonOffset(!1);
    }
    function Wa(E, L, H, V) {
      if ((H.isScene === !0 ? H.overrideMaterial : null) !== null)
        return;
      p.state.transmissionRenderTarget[V.id] === void 0 && (p.state.transmissionRenderTarget[V.id] = new qn(1, 1, {
        generateMipmaps: !0,
      ...
      v.toneMapping = Cn;
      const Ae = V.viewport;
      if (V.viewport !== void 0 && (V.viewport = void 0), p.setupLightsView(V), Q === !0 && J.setGlobalState(v.clippingPlanes, V), Zi(E, H, V), A.updateMultisampleRenderTarget(ee), A.updateRenderTargetMipmap(ee), ze.has("WEBGL_multisampled_render_to_texture") === !1) {
        let Pe = !1;
    ...
    function Xa(E, L, H, V, U, ee) {
      E.onBeforeRender(v, L, H, V, U, ee), E.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse, E.matrixWorld), E.normalMatrix.getNormalMatrix(E.modelViewMatrix), U.onBeforeRender(v, L, H, V, E, ee), U.transparent === !0 && U.side === Kt && U.forceSinglePass === !1 ? (U.side = Ct, U.needsUpdate = !0, v.renderBufferDirect(H, L, V, U, E, ee), U.side = Pn, U.needsUpdate = !0, v.renderBufferDirect(H, L, V, U, E, ee), U.side = Kt) : v.renderBufferDirect(H, L, V, U, E, ee), E.onAfterRender(v, L, H, V, U, ee);
    }
    function Ki(E, L, H) {
      L.isScene !== !0 && (L = it);
    ...
    function mh(E, L, H, V, U) {
      ...
      if (Ee.useProgram(Vt.program) && (Kn = !0, Pt = !0, Di = !0), V.id !== y && (y = V.id, Pt = !0), Kn || x !== E) {
        ...
        ), (V.isMeshPhongMaterial || V.isMeshToonMaterial || V.isMeshLambertMaterial || V.isMeshBasicMaterial || V.isMeshStandardMaterial || V.isShaderMaterial) && nt.setValue(F, "isOrthographic", E.isOrthographicCamera === !0), x !== E && (x = E, Pt = !0, Di = !0);
      }
      if (U.isSkinnedMesh) {
      ...
      if ((Li.position !== void 0 || Li.normal !== void 0 || Li.color !== void 0) && be.update(U, H, Vt), (Pt || Me.receiveShadow !== U.receiveShadow) && (Me.receiveShadow = U.receiveShadow, nt.setValue(F, "receiveShadow", U.receiveShadow)), V.isMeshGouraudMaterial && V.envMap !== null && (jt.envMap.value = _e, jt.flipEnvMap.value = _e.isCubeTexture && _e.isRenderTargetTexture === !1 ? -1 : 1), V.isMeshStandardMaterial && V.envMap === null && L.environment !== null && (jt.envMapIntensity.value = L.environmentIntensity), Pt && (nt.setValue(F, "toneMappingExposure", v.toneMappingExposure), Me.needsLights && _h(jt, Di), ee && V.fog === !0 && se.refreshFogUniforms(jt, ee), se.refreshMaterialUniforms(jt, V, k, K, p.state.transmissionRenderTarget[E.id]), Dr.upload(F, qa(Me), jt, A)), V.isShaderMaterial && V.uniformsNeedUpdate === !0 && (Dr.upload(F, qa(Me), jt, A), V.uniformsNeedUpdate = !1), V.isSpriteMaterial && nt.setValue(F, "center", U.center), nt.setValue(F, "modelViewMatrix", U.modelViewMatrix), nt.setValue(F, "normalMatrix", U.normalMatrix), nt.setValue(F, "modelMatrix", U.matrixWorld), V.isShaderMaterial || V.isRawShaderMaterial) {
    ...
    this.getActiveCubeFace = function() {
      ...
      E.isTexture !== !0 && (Vi("WebGLRenderer: copyTextureToTexture function signature has changed."), V = arguments[0] || null, E = arguments[1], L = arguments[2], U = arguments[3] || 0, H = null);
      ...
      F.pixelStorei(F.UNPACK_ROW_LENGTH, nn), F.pixelStorei(F.UNPACK_IMAGE_HEIGHT, $e), F.pixelStorei(F.UNPACK_SKIP_PIXELS, Vt), F.pixelStorei(F.UNPACK_SKIP_ROWS, Kn), F.pixelStorei(F.UNPACK_SKIP_IMAGES, Pt), U === 0 && L.generateMipmaps && F.generateMipmap(Me), Ee.unbindTexture();
  ...
  raycast(e, n) {
    ...
    if (h !== null) {
      ...
      for (let g = u, m = _ - 1; g < m; g += l) {
        const p = h.getX(g), T = h.getX(g + 1), S = yr(this, e, Hi, c, p, T);
        S && n.push(S);
      }
      if (this.isLineLoop) {
        const g = h.getX(_ - 1), m = h.getX(u), p = yr(this, e, Hi, c, g, m);
        p && n.push(p);
      }
    } else {
      const u = Math.max(0, a.start), _ = Math.min(d.count, a.start + a.count);
      for (let g = u, m = _ - 1; g < m; g += l) {
        const p = yr(this, e, Hi, c, g, g + 1);
        p && n.push(p);
      }
      if (this.isLineLoop) {
  ...
  raycast(e, n) {
    ...
    if (l !== null) {
      ...
      for (let _ = d, g = u; _ < g; _++) {
        const m = l.getX(_);
        Er.fromBufferAttribute(f, m), ec(Er, m, c, r, e, n, this);
      }
    } else {
...
class Ca extends pt {
  constructor(e = 1, n = 1, i = 1, r = 32, s = 1, a = !1, o = 0, c = Math.PI * 2) {
    ...
    function T() {
      ...
      for (let R = 0; R <= s; R++) {
        ...
        for (let z = 0; z <= r; z++) {
          ...
          P.x = C * X, P.y = -x * i + m, P.z = C * G, f.push(P.x, P.y, P.z), v.set(X, w, G).normalize(), d.push(v.x, v.y, v.z), u.push(I, 1 - x), y.push(_++);
        }
        g.push(y);
      }
      for (let R = 0; R < r; R++)
    ...
    function S(v) {
      ...
      for (let z = 1; z <= r; z++)
        f.push(0, m * x, 0), d.push(0, x, 0), u.push(0.5, 0.5), _++;
      const C = _;
      for (let z = 0; z <= r; z++) {
        const N = z / r * c + o, X = Math.cos(N), G = Math.sin(N);
        w.x = y * G, w.y = m * x, w.z = y * X, f.push(w.x, w.y, w.z), d.push(0, x, 0), b.x = X * 0.5 + 0.5, b.y = G * 0.5 * x + 0.5, u.push(b.x, b.y), _++;
      }
      for (let z = 0; z < r; z++) {
        const I = P + z, N = C + z;
...
function fl(t, e, n) {
  var i = e[0], r = e[1], s = e[2], a = e[3], o = e[4], c = e[5], l = e[6], h = e[7], f = e[8], d = n[0], u = n[1], _ = n[2], g = n[3], m = n[4], p = n[5], T = n[6], S = n[7], v = n[8];
  return t[0] = d * i + u * a + _ * l, t[1] = d * r + u * o + _ * h, t[2] = d * s + u * c + _ * f, t[3] = g * i + m * a + p * l, t[4] = g * r + m * o + p * h, t[5] = g * s + m * c + p * f, t[6] = T * i + S * a + v * l, t[7] = T * r + S * o + v * h, t[8] = T * s + S * c + v * f, t;
}
function sv(t, e, n) {
...
function uv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], m = e[14], p = e[15], T = n * o - i * a, S = n * c - r * a, v = n * l - s * a, P = i * c - r * o, b = i * l - s * o, w = r * l - s * c, R = h * g - f * _, y = h * m - d * _, x = h * p - u * _, C = f * m - d * g, z = f * p - u * g, I = d * p - u * m, N = T * I - S * z + v * C + P * x - b * y + w * R;
...
function yv(t, e) {
  var n = t[0], i = t[1], r = t[2], s = t[3], a = t[4], o = t[5], c = t[6], l = t[7], h = t[8], f = e[0], d = e[1], u = e[2], _ = e[3], g = e[4], m = e[5], p = e[6], T = e[7], S = e[8];
...
function Cv(t, e, n, i, r, s, a, o, c, l, h, f, d, u, _, g, m) {
...
function Lv(t, e) {
  var n = e[0], i = e[1], r = e[2], s = e[3], a = e[4], o = e[5], c = e[6], l = e[7], h = e[8], f = e[9], d = e[10], u = e[11], _ = e[12], g = e[13], m = e[14], p = e[15], T = n * o - i * a, S = n * c - r * a, v = n * l - s * a, P = i * c - r * o, b = i * l - s * o, w = r * l - s * c, R = h * g - f * _, y = h * m - d * _, x = h * p - u * _, C = f * m - d * g, z = f * p - u * g, I = d * p - u * m;
  return t[0] = o * I - c * z + l * C, t[1] = r * z - i * I - s * C, t[2] = g * w - m * b + p * P, t[3] = d * b - f * w - u * P, t[4] = c * x - a * I - l * y, t[5] = n * I - r * x + s * y, t[6] = m * v - _ * w - p * S, t[7] = h * w - d * v + u * S, t[8] = a * z - o * x + l * R, t[9] = i * x - n * z - s * R, t[10] = _ * b - g * v + p * T, t[11] = f * v - h * b - u * T, t[12] = o * y - a * C - c * R, t[13] = n * C - i * y + r * R, t[14] = g * S - _ * P - m * T, t[15] = h * P - f * S + d * T, t;
}
function Iv(t) {
  var e = t[0], n = t[1], i = t[2], r = t[3], s = t[4], a = t[5], o = t[6], c = t[7], l = t[8], h = t[9], f = t[10], d = t[11], u = t[12], _ = t[13], g = t[14], m = t[15], p = e * a - n * s, T = e * o - i * s, S = n * o - i * a, v = l * _ - h * u, P = l * g - f * u, b = h * g - f * _, w = e * b - n * P + i * v, R = s * b - a * P + o * v, y = l * S - h * T + f * p, x = u * S - _ * T + g * p;
  return c * w - r * R + m * y - d * x;
}
function pl(t, e, n) {
  var i = e[0], r = e[1], s = e[2], a = e[3], o = e[4], c = e[5], l = e[6], h = e[7], f = e[8], d = e[9], u = e[10], _ = e[11], g = e[12], m = e[13], p = e[14], T = e[15], S = n[0], v = n[1], P = n[2], b = n[3];
  return t[0] = S * i + v * o + P * f + b * g, t[1] = S * r + v * c + P * d + b * m, t[2] = S * s + v * l + P * u + b * p, t[3] = S * a + v * h + P * _ + b * T, S = n[4], v = n[5], P = n[6], b = n[7], t[4] = S * i + v * o + P * f + b * g, t[5] = S * r + v * c + P * d + b * m, t[6] = S * s + v * l + P * u + b * p, t[7] = S * a + v * h + P * _ + b * T, S = n[8], v = n[9], P = n[10], b = n[11], t[8] = S * i + v * o + P * f + b * g, t[9] = S * r + v * c + P * d + b * m, t[10] = S * s + v * l + P * u + b * p, t[11] = S * a + v * h + P * _ + b * T, S = n[12], v = n[13], P = n[14], b = n[15], t[12] = S * i + v * o + P * f + b * g, t[13] = S * r + v * c + P * d + b * m, t[14] = S * s + v * l + P * u + b * p, t[15] = S * a + v * h + P * _ + b * T, t;
}
function Uv(t, e, n) {
...
function Fv(t, e, n, i) {
  var r = i[0], s = i[1], a = i[2], o = Math.sqrt(r * r + s * s + a * a), c, l, h, f, d, u, _, g, m, p, T, S, v, P, b, w, R, y, x, C, z, I, N, X;
  return o < pe ? null : (o = 1 / o, r *= o, s *= o, a *= o, c = Math.sin(n), l = Math.cos(n), h = 1 - l, f = e[0], d = e[1], u = e[2], _ = e[3], g = e[4], m = e[5], p = e[6], T = e[7], S = e[8], v = e[9], P = e[10], b = e[11], w = r * r * h + l, R = s * r * h + a * c, y = a * r * h - s * c, x = r * s * h - a * c, C = s * s * h + l, z = a * s * h + r * c, I = r * a * h + s * c, N = s * a * h - r * c, X = a * a * h + l, t[0] = f * w + g * R + S * y, t[1] = d * w + m * R + v * y, t[2] = u * w + p * R + P * y, t[3] = _ * w + T * R + b * y, t[4] = f * x + g * C + S * z, t[5] = d * x + m * C + v * z, t[6] = u * x + p * C + P * z, t[7] = _ * x + T * C + b * z, t[8] = f * I + g * N + S * X, t[9] = d * I + m * N + v * X, t[10] = u * I + p * N + P * X, t[11] = _ * I + T * N + b * X, e !== t && (t[12] = e[12], t[13] = e[13], t[14] = e[14], t[15] = e[15]), t);
}
function Ov(t, e, n) {
...
function $v(t, e, n, i) {
  ...
  var u = 1 / n[0], _ = 1 / n[1], g = 1 / n[2], m = r * u, p = s * _, T = a * g, S = o * u, v = c * _, P = l * g, b = h * u, w = f * _, R = d * g, y = m + v + R, x = 0;
...
function Yv(t, e, n, i) {
  var r = e[0], s = e[1], a = e[2], o = e[3], c = r + r, l = s + s, h = a + a, f = r * c, d = r * l, u = r * h, _ = s * l, g = s * h, m = a * h, p = o * c, T = o * l, S = o * h, v = i[0], P = i[1], b = i[2];
  return t[0] = (1 - (_ + m)) * v, t[1] = (d + S) * v, t[2] = (u - T) * v, t[3] = 0, t[4] = (d - S) * P, t[5] = (1 - (f + m)) * P, t[6] = (g + p) * P, t[7] = 0, t[8] = (u + T) * b, t[9] = (g - p) * b, t[10] = (1 - (f + _)) * b, t[11] = 0, t[12] = n[0], t[13] = n[1], t[14] = n[2], t[15] = 1, t;
}
function jv(t, e, n, i, r) {
  var s = e[0], a = e[1], o = e[2], c = e[3], l = s + s, h = a + a, f = o + o, d = s * l, u = s * h, _ = s * f, g = a * h, m = a * f, p = o * f, T = c * l, S = c * h, v = c * f, P = i[0], b = i[1], w = i[2], R = r[0], y = r[1], x = r[2], C = (1 - (g + p)) * P, z = (u + v) * P, I = (_ - S) * P, N = (u - v) * b, X = (1 - (d + p)) * b, G = (m + T) * b, K = (_ + S) * w, k = (m - T) * w, te = (1 - (d + g)) * w;
...
function fx(t, e) {
  var n = t[0], i = t[1], r = t[2], s = t[3], a = t[4], o = t[5], c = t[6], l = t[7], h = t[8], f = t[9], d = t[10], u = t[11], _ = t[12], g = t[13], m = t[14], p = t[15], T = e[0], S = e[1], v = e[2], P = e[3], b = e[4], w = e[5], R = e[6], y = e[7], x = e[8], C = e[9], z = e[10], I = e[11], N = e[12], X = e[13], G = e[14], K = e[15];
...
async function Ey(t, e = {}) {
  ...
  (o <= 0 || c <= 0) && (o = 1), c <= 0 && (c = 1);
  const l = 1 / o, h = n.eps / c, f = n.tMax > 1 ? Math.log(l / h) / (n.tMax - 1) : 0, d = (v) => v >= n.tMax ? h : l * Math.exp(-f * v), u = new Float32Array(r * 3);
  for (let v = 0; v < r; v++)
    u[v * 3] = (Math.random() * 2 - 1) * n.simulationBound, u[v * 3 + 1] = (Math.random() * 2 - 1) * n.simulationBound, u[v * 3 + 2] = (Math.random() * 2 - 1) * n.simulationBound;
  let _ = 0;
  const g = {
    pi: ln.create(),
    pj: ln.create(),
  ...
  function p(v) {
    const P = Math.max(1, n.iterationsPerStep), b = n.useSchedule ? d(_) : n.learningRate;
    _ += n.scheduleSpeed;
    for (let w = 0; w < P && a.length !== 0; w++) {
      const R = a[Math.floor(Math.random() * a.length)], { i: y, j: x, d: C, w: z } = R;
      ln.set(g.pi, u[y * 3], u[y * 3 + 1], u[y * 3 + 2]), ln.set(g.pj, u[x * 3], u[x * 3 + 1], u[x * 3 + 2]), ln.subtract(g.diff, g.pj, g.pi);
      const I = Math.max(ln.length(g.diff), m);
      let N = b * z;
      N > 1 && (N = 1);
      const X = N * (I - C) / (2 * I);
      ln.scale(g.diff, g.diff, X), u[y * 3] -= g.diff[0], u[y * 3 + 1] -= g.diff[1], u[y * 3 + 2] -= g.diff[2], u[x * 3] += g.diff[0], u[x * 3 + 1] += g.diff[1], u[x * 3 + 2] += g.diff[2];
    }
    if (n.centerPull > 0)
      for (let w = 0; w < r; w++)
        u[w * 3] -= n.centerPull * u[w * 3], u[w * 3 + 1] -= n.centerPull * u[w * 3 + 1], u[w * 3 + 2] -= n.centerPull * u[w * 3 + 2];
    if (n.scaleBound > 0 && r > 0) {
      g.centroid[0] = 0, g.centroid[1] = 0, g.centroid[2] = 0;
      for (let R = 0; R < r; R++)
        g.centroid[0] += u[R * 3], g.centroid[1] += u[R * 3 + 1], g.centroid[2] += u[R * 3 + 2];
      g.centroid[0] /= r, g.centroid[1] /= r, g.centroid[2] /= r;
      let w = 0;
      for (let R = 0; R < r; R++) {
        u[R * 3] -= g.centroid[0], u[R * 3 + 1] -= g.centroid[1], u[R * 3 + 2] -= g.centroid[2];
        const y = Math.sqrt(
          u[R * 3] * u[R * 3] + u[R * 3 + 1] * u[R * 3 + 1] + u[R * 3 + 2] * u[R * 3 + 2]
        );
        y > w && (w = y);
      }
      if (w > n.scaleBound) {
        const R = n.scaleBound / w;
        for (let y = 0; y < r * 3; y++) u[y] *= R;
      }
    }
  }
  function T() {
