...
/**
 * Draw vertices as a point cloud with updatable positions. Use in animation loops:
 * call updatePositions(simulation.getPositions()) each frame. Node order matches get_node_ids_order().
 */
...
/**
 * Draw edges as thin lines with updatable geometry. Call updateEdges() each frame
 * after updating the graph's position map and edge map (e.g. DrawEdgeLinesDivisions + apply_edge_pos_maps).
 */
